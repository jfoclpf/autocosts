...
function getMetaDescription(initial_text){
    return initial_text.
...
function getSubTitleArr(position, words, statsData){
    ...
    var sub_title1a = words.sub_title1a ? words.sub_title1a.trim() : "";
    var sub_title1b = words.sub_title1b ? words.sub_title1b.trim() : "";
    var sub_title2 = words.sub_title2 ? words.sub_title2.trim() : "";
    ...
    if(position === 1){
        ...
        let costs_totalPerYear_string = getProcessedStatsDataEntry(            
            words,
            statsData,
        ...
        sub_title1a_part2 = sub_title1a_part2.replace("[yearly_costs]", costs_totalPerYear_string);
