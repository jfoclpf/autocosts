...
autocosts.databaseModule = (function(thisModule, serverInfo, userInfo){   
    ...
    function submitResultsToDatabase() {
        ...
        objectToDb.time_to_fill_form = userInfo.timeCounter.getCurrentTimeInSeconds();

        //get a user unique generated ID
        objectToDb.client_uuid = userInfo.uniqueUserId;

        objectToDb.country = serverInfo.selectedCountry; //Country is a global variable
