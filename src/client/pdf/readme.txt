The standard fonts virtual file is `js/pdf/vfs_fonts.js`. Though, languages and alphabets that need special fonts, such as CN, JP or IN 
they load such fonts from different virtual files stored in `js/pdf/XX/vfs_fonts.js`.
