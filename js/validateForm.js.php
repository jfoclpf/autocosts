...
function is_userdata_formpart1_ok(){
    ...
    if(!isNumber(document.custo.seguro_val.value)){
        alert("<?php echo $INSURANCE ?> - <?php echo $ERROR_INVALID_INSU_VALUE ?>!");
        return false;
    }

    if(tipo_seguro_auto == ""){
        alert("<?php echo $INSURANCE ?> - <?php echo $ERROR_INSU_PERIOD ?>!");
        return false;
    }
    ...
    if(!isNumber(auto_mes) || !isInteger(auto_mes) || auto_mes>12 || auto_mes<=0){
        alert("<?php echo $DEPRECIATION ?> - <?php echo $ERROR_DEPRECIATION_MONTH ?>!");
        return false;
    }
    if(!isNumber(document.custo.auto_ano.value) || !isInteger(document.custo.auto_ano.value)){
        alert("<?php echo $DEPRECIATION ?> - <?php echo $ERROR_DEPRECIATION_YEAR ?>!");
        return false;
    }
    if(!isNumber(document.custo.auto_val_inicial.value)){
        alert("<?php echo $DEPRECIATION ?> - <?php echo $ERROR_DEPRECIATION_VALUE ?>!");
        return false;
    }
    if(!isNumber(document.custo.auto_val_final.value)){
        alert("<?php echo $DEPRECIATION ?> - <?php echo $ERROR_DEPRECIATION_VALUE_TODAY ?>!");
        return false;
    }
    ...
    if(!meses){
        alert("<?php echo $DEPRECIATION ?> - <?php echo $ERROR_DEPRECIATION_DATE ?>!");
        return false;
    }
    ...
    if(cred_auto_s_n == ""){
        alert("<?php echo $ERROR_CREDIT_QUESTION ?>!");
        return false;
    }

    if(cred_auto_s_n == "true") {
        if(!isNumber(document.custo.cred_auto_montante.value)) {
            alert("<?php echo $CREDIT ?> - <?php echo $ERROR_CREDIT_LOAN_VALUE ?>!");
            return false;
        }
        if(!isNumber(document.custo.cred_auto_period.value)) {
            alert("<?php echo $CREDIT ?> - <?php echo $ERROR_CREDIT_PERIOD ?>!");
            return false;
        }
        if(!isNumber(document.custo.cred_auto_val_mes.value)) {
            alert("<?php echo $CREDIT ?> - <?php echo $ERROR_CREDIT_INSTALMENT ?>!");
            return false;
        }
        if(!isNumber(document.custo.cred_auto_valresidual.value)) {
            alert("<?php echo $CREDIT ?> - <?php echo $ERROR_CREDIT_RESIDUAL_VALUE ?>!");
            return false;
        }
    }
    ...
    if(!isNumber(nmr_times_inspec) || !isInteger(nmr_times_inspec)) {
        alert("<?php echo $INSPECTION ?> - <?php echo $ERROR_INSPECTION_NTIMES ?>!");
        return false;
    }

    if(!isNumber(document.custo.preco_inspecao.value) && nmr_times_inspec!=0) {
        alert("<?php echo $INSPECTION ?> - <?php echo $ERROR_INSPECTION_COSTS ?>!");
        return false;
    }
    
    /*taxes*/
    if(!isNumber(document.custo.IUC.value)) {
        alert("<?php echo $ROAD_TAXES ?> - <?php echo $INVALID_AMOUNT ?>!");
        return false;
    }
...
function is_userdata_formpart2_ok(){
    ...
    if(tipo_calc_combustiveis == ""){
        alert("<?php echo $FUEL ?> - <?php echo $ERROR_FUEL_CURR_DIST ?>!");
        return false;
    }
    ...
    case "km": /*fuel calculations made considering distance travelled by month*/
        ...
        if(!isNumber(document.custo.consumo_auto.value)){
            alert("<?php echo $FUEL ?> - <?php echo $ERROR_FUEL_CAR_EFF ?>!");
            return false;
        }
        if(!isNumber(document.custo.fuel_price.value)){
            alert("<?php echo $FUEL ?> - <?php echo $ERROR_FUEL_PRICE ?>!");
            return false;
        }
        ...
        if(leva_auto_job == ""){
            alert("<?php echo $FUEL ?> - <?php echo $ERROR_CAR_JOB ?>!");
            return false;
        }
        ...
        if (leva_auto_job=="false"){
            ...
            if(!isNumber(document.custo.km_por_mes.value)){
                alert("<?php echo $FUEL ?> - <?php echo $ERROR_FUEL_DIST ?>!");
                return false;
            }
            ...
            if(!isNumber(document.custo.dias_por_semana.value) || (document.custo.dias_por_semana.value)>7){
                alert("<?php echo $FUEL ?> - <?php echo $ERROR_DAYS_PER_WEEK ?>!");
                return false;
            }
            if(!isNumber(document.custo.km_entre_casa_trabalho.value)){
                alert("<?php echo $FUEL ?> - <?php echo $ERROR_DIST_HOME_WORK ?>!");
                return false;
            }
            if(!isNumber(document.custo.km_fds.value)){
                alert("<?php echo $FUEL ?> - <?php echo $ERROR_DIST_NO_JOB ?>!");
                return false;
            }
    ...
    case "euros":/*fuel costs based on data input money per period of time*/
        ...
        if(!isNumber(document.custo.combustiveis_euro.value)){
            alert("<?php echo $FUEL ?> - <?php echo $ERROR_CURRENCY ?>!");
            return false;
        }
        break;
    }
    ...
    if(!isNumber(document.custo.revisoes.value)) {
        alert("<?php echo $MAINTENANCE ?> - <?php echo $INVALID_AMOUNT ?>!");
        return false;
    }

    /*repairs*/
    if(!isNumber(document.custo.reparacoes.value)) {
        alert("<?php echo $REP_IMPROV ?> - <?php echo $INVALID_AMOUNT ?>!");
        return false;
    }
    
    /*parking*/
    if(!isNumber(document.custo.parqueamento.value)){
        alert("<?php echo $PARKING ?> - <?php echo $INVALID_AMOUNT ?>!");
        return false;
    }
    ...
    if(tipo_calc_portagens=="false") {/*monthly basis*/
        if(!isNumber(document.custo.portagens.value)) {
            alert("<?php echo $TOLLS ?> - <?php echo $INVALID_AMOUNT ?>!");
            return false;
        }

    } else {/*daily basis*/
        if(!isNumber(document.custo.preco_portagens_por_dia.value)) {
            alert("<?php echo $TOLLS ?> - <?php echo $TOLLS_DAY_CALC1 ?> - <?php echo $INVALID_AMOUNT ?>!");
            return false;
        }
        ...
        if(!isNumber(toll_days_pmonth) || !isInteger(toll_days_pmonth) || toll_days_pmonth>31) {
            alert("<?php echo $TOLLS ?> - <?php echo $DAYS ?> - <?php echo $INVALID_AMOUNT ?>!");
            return false;
        }
    ...
    if(!isNumber(document.custo.multas.value)){
        alert("<?php echo $FINES ?> - <?php echo $INVALID_AMOUNT ?>!");
        return false;
    }
    
    /*washing*/
    if(!isNumber(document.custo.lavagens.value)){
        alert("<?php echo $WASHING ?> - <?php echo $INVALID_AMOUNT ?>!");
        return false;
    }
...
function is_userdata_formpart3_ok(){
    ...
    if(public_transport){
        ...
        if(!isNumber(n_pess_familia) || !isInteger(n_pess_familia) || n_pess_familia<=0){
            alert("<?php echo $EXTRA_DATA1 ?> - <?php echo $INVALID_NBR_PP ?>!");
            return false;
        }

        if(!isNumber(pmpmpc) || pmpmpc<0){
            alert("<?php echo $EXTRA_DATA1 ?> - <?php echo $ERROR_PASS_AMOUNT ?>!");
            return false;
        }
    }
    ...
    if(fin_effort){
        ...
        case 'year':
            if(!isNumber(document.custo.income_per_year.value)){
                alert("<?php echo $EXTRA_DATA_INCOME ?> - <?php echo $ERROR_INCOME ?>!");
                return false;
            }			
            break;
        case 'month':
            ...
            if(!isNumber(document.custo.income_months_per_year.value)){
                alert("<?php echo $EXTRA_DATA_INCOME ?> - <?php echo $ERROR_MONTHS_PER_YEAR ?>!");
                return false;
            }			
            break;
        case 'week':
            ...
            if(!isNumber(document.custo.income_weeks_per_year.value)){
                alert("<?php echo $EXTRA_DATA_INCOME ?> - <?php echo $ERROR_WEEKS_PER_YEAR ?>!");
                return false;
            }			
            break;
        }
        ...
        if(is_working_time == 'true' && income_type!='hour'){
            if(!isNumber(document.custo.time_hours_per_week.value)){
                alert("<?php echo $EXTRA_DATA_WORKING_TIME ?> - <?php echo $ERROR_HOURS_PER_WEEK ?>!");
                return false;
            }
            if(!isNumber(document.custo.time_month_per_year.value)){
                alert("<?php echo $EXTRA_DATA_WORKING_TIME ?> - <?php echo $ERROR_MONTHS_PER_YEAR ?>!");
                return false;
            }
        }
    }
    ...
    if(public_transport || fin_effort){
        ...
        if($('#distance_form3').css('display')!='none'){
            ...
            if(drive_to_work == 'true'){
                if(!isNumber(document.custo.drive_to_work_days_per_week.value)){
                    alert("<?php echo $DISTANCE ?> - <?php echo $ERROR_DAYS_PER_WEEK ?>!");
                    return false;
                }
                if(!isNumber(document.custo.dist_home_job.value)){
                    alert("<?php echo $DISTANCE ?> - <?php echo $ERROR_DIST_HOME_WORK ?>!");
                    return false;
                }
                if(!isNumber(document.custo.journey_weekend.value)){
                    alert("<?php echo $DISTANCE ?> - <?php echo $ERROR_DIST_NO_JOB ?>!");
                    return false;
                }
            }
            else{
                if(!isNumber(document.custo.km_per_month.value)){
                    alert("<?php echo $DISTANCE ?> - <?php echo $ERROR_FUEL_DIST ?>!");
                    return false;
                }
            }
        }
        ...
        if (isVisible('.time_spent_part1_form3')){        
            if(!isNumber(document.custo.time_home_job.value)){
                alert("<?php echo $EXTRA_DATA_TIME_SPENT_IN_DRIVING ?> - <?php echo $ERROR_MIN_DRIVE_HOME_JOB ?>!");
                return false;
            }
            if(!isNumber(document.custo.time_weekend.value)){
                alert("<?php echo $EXTRA_DATA_TIME_SPENT_IN_DRIVING ?> - <?php echo $ERROR_MIN_DRIVE_WEEKEND ?>!");
                return false;
            }
        }
        else{
            if(!isNumber(document.custo.min_drive_per_day.value)){
                alert("<?php echo $EXTRA_DATA_TIME_SPENT_IN_DRIVING ?> - <?php echo $ERROR_MIN_DRIVE ?>!");
                return false;
            }
            ...
            if(!isNumber(days_drive_per_month) || !isInteger(days_drive_per_month) || days_drive_per_month>31){
                alert("<?php echo $EXTRA_DATA_TIME_SPENT_IN_DRIVING ?> - <?php echo $ERROR_DAYS_PER_MONTH ?>!");
                return false;
            }
        }
    }
