<div id="div3">
    <div id="div3a" class="roundCornerSlight">
        ...
        <?php
        if ($is_logo)
            echo '<img alt="Logo" src="'.$CDN_URL.'images/logos/' . get_logo_file_name($is_logo, $currency_logo, $language) . '" id="ac_logo">';
        else
        ...
        <a class="display_block" target="_blank" href="https://play.google.com/store/apps/details?id=info.autocosts">
            <div id="div31" class="roundCorner">
                <img alt="Android logo" src="<?php echo $CDN_URL ?>images/android/android_robot.svg">
                <img alt="Android logo" src="<?php echo $CDN_URL ?>images/android/android_text.svg">
            </div>
        </a>
