...
$EXTRA_DATA_INCOME_QUESTION = 'Jaki jest Twój dochód netto? What is your net income?';
$EXTRA_DATA_WORKING_TIME = 'Czas pracy Working time';
$EXTRA_DATA_WORKING_TIME_QUESTION = 'Pracujesz lub posiadasz jakieś godne zajęcie? Do you have a job or a worthy occupation?';
$EXTRA_DATA_TIME_SPENT_IN_DRIVING = 'Czas spędzony na jeździe Time spent in driving';
$EXTRA_DATA_TIME_QUESTION1 = 'Ile minut zajmuje Ci dojaz z domu do miejsca pracy (w jedną stronę)?How many minutes you drive from home to workplace? (just one way)';
$EXTRA_DATA_TIME_QUESTION2 = 'Ile czasu spędzasz za kierownicą, gdy nie jedziesz do pracy samochodem? How many minutes you drive in the days you don\'t take the car to workplace?';
$EXTRA_DATA_TIME_QUESTION3 = 'Ile minut jedziesz samochodem? How many minutes you drive?';
...
$DAYS_DRIVE_PER_MONTH = 'Liczba przejechanych drzwi na';
