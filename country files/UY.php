...
$ROAD_TAXES_VALUE = 'Impuesto específico interno (Imesi):<br><i>pago realizado al estado</i>';

//fuel
$FUEL = 'Combustible';
$FUEL_DESC = 'Nafta, diesel, gasoil GLP, electricidad';
