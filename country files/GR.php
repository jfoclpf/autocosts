...
$BUTTON_RUN = 'Υπολογισμός'; //run simulator button 
$BUTTON_RERUN = 'Νέος υπολογισμός'; //run simulator button 

//WEB PAGE
$WEB_PAGE_TITLE = 'Υπολογιστής εξόδων αυτοκινήτου';
$MAIN_TITLE = 'ΥΠΟΛΟΓΙΣΤΗΣ ΕΞΟΔΩΝ ΑΥΤΟΚΙΝΗΤΟΥ';
$INITIAL_TEXT = 
"Αυτή η εφαρμογή θα σας επιτρέψει να υπολογίσετε <b>τα πραγματικά έξοδα</b> ενός αυτοκινήτου στην <b>Ελλάδα</b>. Θα σας δώσει μια σωστή εκτίμηση για το πόσα πραγματικά χρειάζεται να ξοδεύετε ως ιδιοκτήτες ενός αυτοκινήτου. Καθώς τα έξοδα του αυτοκινήτου τρέχουν όλο το χρόνο, συχνά είναι δύσκολο να έχει κανείς μια πλήρη εικόνα των συνολικών εξόδων του αυτοκινήτου του. <br> <br> Να είστε ρεαλιστές με τα δεδομένα που εισάγετε. Για έκτακτα έξοδα, όπως επιδιορθώσεις έπειτα από τροχαία ατυχήματα ή πρόστιμα, υπολογίστε πόσα έχετε δαπανήσει σε παρόμοιες περιπτώσεις τα τελευταία χρόνια. Από προεπιλογή, οι τιμές αυτές έχουν υπολογιστεί σε μηνιαία βάση. Χρησιμοποιήστε το σημείο για δεκαδικούς, για παράδειγμα <span style=\"color:rgb(255,0,0);\">8.7</span> χιλιόμετρα μεταξύ σπιτιού και εργασίας.<br>";
