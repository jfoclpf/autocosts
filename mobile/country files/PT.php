...
$STD_INSPECTION_PRICE = '30'; //normal inspection price
...
$STD_FUEL_PRICE = '1.5'; //price paid for fuel on chosen currency

$STD_MAINTENANCE_PER_YEAR = '250'; //amount paid for maintenance per year
