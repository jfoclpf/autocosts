...
$STD_PRICE_PAID = '40000'; //price paid for the car
$STD_PRICE_TODAY = '5000'; //the price the car has today

$STD_INSURANCE_SEM = '150'; //price paid for insurance by semester

$STD_LOAN = '60000'; //amount asked for credit
$STD_PERIOD_OF_CREDIT = '48'; //period of the credit in months
$STD_MONTHLY_PAY = '900'; //monthly payment
$STD_RESIDUAL_VALUE = '1500'; //residual value must be paid after credit

$STD_NBR_INSPECTION = '5'; //number of times car went to inspection
$STD_INSPECTION_PRICE = '150'; //normal inspection price

$STD_ROAD_TAX = '150'; //price paid for road taxes per year
...
$STD_FUEL_PRICE = '5.7'; //price paid for fuel on chosen currency
...
$STD_PARKING = '150'; //parking paid per month

$STD_TOLLS = '150'; //amount paid in tolls per trimestre 
$STD_TOLLS_DAY = '3'; //amount paid in tolls per day
$STD_TOLLS_DAYS_PER_MONTH = '22'; //number of days per month the car crosses a tolled way

$STD_FINES = '30'; //fines paid on average per trimestre

$STD_WASHING = '30'; //amount paid in washings per trimestre
