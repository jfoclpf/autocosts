...
function Run2(callback){
    ...
    if(SOCIAL_SWITCH){
        $("#shareIcons").jsSocials({
            url: 'http://autocostos.info/PR',
            text: 'Esta calculadora te permitirá conocer el verdadero costo de ser propietario de un vehículo en Puerto Rico',
            showLabel: false,
            showCount: false,
...
function print_costs_table(f1, f2, f3, data) {
    ...
    {
        case "semestral":
            insurance_text = f1.insurance_value + " Dólares por semestre";
            break;
        case "anual":
            insurance_text = f1.insurance_value + " Dólares por año";
            break;
        case "mensal":
            insurance_text = data.monthly_costs.insurance + " Dólares por mes";
            break;
        case "trimestral":
            insurance_text = f1.insurance_value + " Dólares por trimestre";
            break;
    }
    ...
    if (f1.nmr_times_inspec !== 0){
        inspection_text = "<b>Inspección Mecánida Vehicular (IMV)</b><br>" +
                          f1.nmr_times_inspec +
                          " veces, costando " +
                          f1.inspec_price +
                          " &#36; cada una durante " +
    ...
    //Taxes
    var cartax_text = "<b>Arbitrio del vehículo</b><br>" +
                      f1.car_tax + " Dólares por año";
    ...
    switch(f2.type_calc_fuel){
        ...
        case "euros":
            ...
            {
                case "1":
                    fuel_text = f2.fuel_money + " Dólares por mes";
                    break;
                case "2":                   
                    fuel_text = f2.fuel_money + " kilómetros por bimestre";
                    break;
                case "3":                   
                    fuel_text = f2.fuel_money + " Dólares por trimestre";
                    break;
                case "4":                   
                    fuel_text = f2.fuel_money + " Dólares por semestre";
                    break;
                case "5":                   
                    fuel_text = f2.fuel_money + " Dólares por año";
                    break;
            }
            break;
    }
    ...
    var maintenance_text = "<b>1/2 Mantenimiento</b><br>" +
                           f2.maintenance + " Dólares por año";
    
    //Repairs
    var repairs_text = "<b>Reparaciones y mejoras<\/span></b><br>" +
                       f2.repairs + " Dólares por año";
    ...
    if(f2.type_calc_tolls == "false") {
        switch(data.tolls_period) {
            case "1":
                tolls_text += f2.tolls + " Dólares por mes";
                break;
            case "2":
                tolls_text += f2.tolls + " Dólares por cada bimestre";
                break;
            case "3":
                tolls_text += f2.tolls + " Dólares por trimestre";
                break;
            case "4":
                tolls_text += f2.tolls + " Dólares por semestre";
                break;
            case "5":
                tolls_text += f2.tolls + " Dólares por año";
                break;
        }
    }
    else 
        tolls_text+=f2.price_tolls_p_day + " Dólares durante " + f2.tolls_days_p_month + " mes";
    tolls_text += "";
    ...
    switch(data.fines_period) {
        case "1":           
            fines_text += f2.fines + " Dólares por mes";
            break;
        case "2":           
            fines_text += f2.fines + " Dólares por cada bimestre";
            break;
        case "3":           
            fines_text += f2.fines+" Dólares por trimestre";
            break;
        case "4":           
            fines_text += f2.fines + " Dólares por semestre";
            break;
        case "5":           
            fines_text += f2.fines + " Dólares por año";
            break;
        }
    fines_text+="";
    ...
    switch(data.washing_period) {
        case "1":
            washing_text += f2.washing + " Dólares por mes";
            break;
        case "2":
            washing_text += f2.washing + " Dólares por cada bimestre";
            break;
        case "3":
            washing_text += f2.washing +" Dólares por trimestre";
            break;
        case "4":
            washing_text += f2.washing + " Dólares por semestre";
            break;
        case "5":
            washing_text += f2.washing + " Dólares por año";
            break;
        }
    washing_text+="";
    ...
    varResult+= "<tr><td><b>Seguro de Responsabilidad obligatorio</b><br>" + insurance_text + "</td>" +
