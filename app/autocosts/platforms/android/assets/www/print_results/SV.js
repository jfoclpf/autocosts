...
function Run2(callback){
    ...
    if(SOCIAL_SWITCH){
        $("#shareIcons").jsSocials({
            url: 'http://autocostos.info/SV',
            text: 'Esta calculadora te permitirá conocer el verdadero costo de ser propietario de un vehículo en El Salvador',
            showLabel: false,
            showCount: false,
...
function print_costs_table(f1, f2, f3, data) {
    ...
    {
        case "semestral":
            insurance_text = f1.insurance_value + " Colones por semestre";
            break;
        case "anual":
            insurance_text = f1.insurance_value + " Colones por año";
            break;
        case "mensal":
            insurance_text = data.monthly_costs.insurance + " Colones por mes";
            break;
        case "trimestral":
            insurance_text = f1.insurance_value + " Colones por trimestre";
            break;
    }
    ...
    switch(f2.type_calc_fuel){
        case "km":                     
            if (f2.take_car_to_job == "false"){
                ...
                fuel_text = fuel_text + "<br>" + "Eficacia del combustible de tu vehículo: " + f2.car_consumption + " km/gal&nbsp;";
                fuel_text = fuel_text + "<br>" + "Precio medio del combustible: " + f2.fuel_price + " ¢/gal&nbsp;&nbsp;";
            }
            else{
                ...
                fuel_text = fuel_text + "Eficacia del combustible de tu vehículo: " + f2.car_consumption + " km/gal";
                fuel_text = fuel_text + "<br>" + "Gasto promedio en combustible: " + f2.fuel_price + " ¢/gal";
            }
            break;
        case "euros":
            ...
            {
                case "1":
                    fuel_text = f2.fuel_money + " Colones por mes";
                    break;
                case "2":                   
                    fuel_text = f2.fuel_money + " kilómetros por bimestre";
                    break;
                case "3":                   
                    fuel_text = f2.fuel_money + " Colones por trimestre";
                    break;
                case "4":                   
                    fuel_text = f2.fuel_money + " Colones por semestre";
                    break;
                case "5":                   
                    fuel_text = f2.fuel_money + " Colones por año";
                    break;
            }
            break;
    }
    ...
    var maintenance_text = "<b>1/2 Mantenimiento</b><br>" +
                           f2.maintenance + " Colones por año";
    
    //Repairs
    var repairs_text = "<b>Reparaciones y mejoras<\/span></b><br>" +
                       f2.repairs + " Colones por año";
    ...
    if(f2.type_calc_tolls == "false") {
        switch(data.tolls_period) {
            case "1":
                tolls_text += f2.tolls + " Colones por mes";
                break;
            case "2":
                tolls_text += f2.tolls + " Colones por cada bimestre";
                break;
            case "3":
                tolls_text += f2.tolls + " Colones por trimestre";
                break;
            case "4":
                tolls_text += f2.tolls + " Colones por semestre";
                break;
            case "5":
                tolls_text += f2.tolls + " Colones por año";
                break;
        }
    }
    else 
        tolls_text+=f2.price_tolls_p_day + " Colones durante " + f2.tolls_days_p_month + " mes";
    tolls_text += "";
    ...
    switch(data.fines_period) {
        case "1":           
            fines_text += f2.fines + " Colones por mes";
            break;
        case "2":           
            fines_text += f2.fines + " Colones por cada bimestre";
            break;
        case "3":           
            fines_text += f2.fines+" Colones por trimestre";
            break;
        case "4":           
            fines_text += f2.fines + " Colones por semestre";
            break;
        case "5":           
            fines_text += f2.fines + " Colones por año";
            break;
        }
    fines_text+="";
    ...
    switch(data.washing_period) {
        case "1":
            washing_text += f2.washing + " Colones por mes";
            break;
        case "2":
            washing_text += f2.washing + " Colones por cada bimestre";
            break;
        case "3":
            washing_text += f2.washing +" Colones por trimestre";
            break;
        case "4":
            washing_text += f2.washing + " Colones por semestre";
            break;
        case "5":
            washing_text += f2.washing + " Colones por año";
            break;
        }
    washing_text+="";
    ...
    varResult+= "<tr><td><b>Seguro vehicular</b><br>" + insurance_text + "</td>" +
