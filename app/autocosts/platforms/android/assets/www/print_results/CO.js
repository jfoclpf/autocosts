...
function Run2(callback){
    ...
    if(SOCIAL_SWITCH){
        $("#shareIcons").jsSocials({
            url: 'http://autocostos.info/CO',
            text: 'Esta calculadora te permitirá conocer el verdadero costo de ser propietario de un vehículo en Colombia',
            showLabel: false,
            showCount: false,
...
function print_costs_table(f1, f2, f3, data) {
    ...
    if (f1.nmr_times_inspec !== 0){
        inspection_text = "<b>Revisión técnico-mecánica</b><br>" +
                          f1.nmr_times_inspec +
                          " veces, costando " +
                          f1.inspec_price +
                          " &#36; cada una durante " +
