...
function Run2(callback){
    ...
    if(SOCIAL_SWITCH){
        $("#shareIcons").jsSocials({
            url: 'http://autocosts.info/US',
            text: 'This calculator will allow you to find the true cost of owning a car in the United States',
            showLabel: false,
            showCount: false,
...
function print_result_final_text(data){
    ...
    if(data.total_costs_month >= 150 && data.age_months > 6) {
        ...
        var text_msg = '<div>With this level of costs, your vehicle during the '+
                       '<b>' + data.age_months + '</b> months of possession has already been determined:</div>'+
...
function print_costs_table(f1, f2, f3, data) {
    ...
    if (data.age_months === 0) {    
        ...
        depreciation_text = "<b>Depreciation of the vehicle<\/span></b>&nbsp;&nbsp;<br>Acquisition value: "+
            f1.auto_initial_cost + "&#36;<br>Final value: "+
            f1.auto_final_cost + "&#36;<br>Time period of ownership: "+
    ...
    {
        case "semestral":
            insurance_text = f1.insurance_value + " Dollars per semester";
            break;
        case "anual":
            insurance_text = f1.insurance_value + " Dollars per year";
            break;
        case "mensal":
            insurance_text = data.monthly_costs.insurance + " Dollars per month";
            break;
        case "trimestral":
            insurance_text = f1.insurance_value + " Dollars per trimester";
            break;
    }
    
    //Credit interests
    var interests_text="<b>Loan interest<\/b>&nbsp;&nbsp;";
    
    if(f1.cred_auto_s_n == "true") {

        interests_text = "<b>Loan interest</b>&nbsp;&nbsp;<br>Financed amount: " +
                         f1.credit_amount +
                         "&#36;<br>Credit period / number of installments: " +
                         f1.credit_period +
        ...
        interests_text += "Total amount of interest paid: "+data.total_interests+"&#36;<br>(" + data.month_cred + "*"+ f1.credit_value_p_month + ")+" + f1.credit_residual_value + "-" + f1.credit_amount;

        if(data.age_months >= data.month_cred)
            interests_text += "<br>Monthly amount spent on interest: "+data.monthly_costs.credit.toFixed(2)+"&#36;";
        interests_text += "";
    } 
    ...
    if (f1.nmr_times_inspec !== 0){
        inspection_text = "<b>Vehicle inspection</b><br>" +
                          f1.nmr_times_inspec +
                          " times costing " +
                          f1.inspec_price +
                          " &#36; each one during " +
    ...
    //Taxes
    var cartax_text = "<b>Vehicle Excise Tax (Auto taxes, if applicable)</b><br>" +
                      f1.car_tax + " Dollars per year";
    ...
    switch(f2.type_calc_fuel){
        case "km":                     
            if (f2.take_car_to_job == "false"){
                ...
                {
                    case "1":
                        fuel_text = f2.distance + " mi per month";
                        break;
                    case "2":                   
                        fuel_text = f2.distance + " miles for every two months";
                        break;
                    case "3":                   
                        fuel_text = f2.distance + " mi per trimester";
                        break;
                    case "4":                   
                        fuel_text = f2.distance + " mi per semester";
                        break;
                    case "5":                   
                        fuel_text = f2.distance + " mi per year";
                        break;
                }
                fuel_text = fuel_text + "<br>" + "Fuel efficiency of your vehicle: " + f2.car_consumption + " mpg(US)&nbsp;";
                fuel_text = fuel_text + "<br>" + "Average price of gas: " + f2.fuel_price + " &#36;/gallon&nbsp;&nbsp;";
            }
            else{
                fuel_text = f2.days_p_week + " Day(s) per week you drive to work <br>";
                fuel_text = fuel_text + "You drive " + f2.distance_home2job + " miles between home and the workplace <br>";
                fuel_text = fuel_text + "You drive " + f2.distance_weekend + " miles on average during the days you don't take your car to the workplace&nbsp;<br>";
                fuel_text = fuel_text + "Total mileage driven on average " + data.distance_per_month.toFixed(1) + " mi per month (~30.5 days) <br>";
                fuel_text = fuel_text + "Fuel efficiency of your vehicle: " + f2.car_consumption + " mpg(US)";
                fuel_text = fuel_text + "<br>" + "Average price you pay for fuel/gas: " + f2.fuel_price + " &#36;/gallon";
            }
            break;
        case "euros":
            ...
            {
                case "1":
                    fuel_text = f2.fuel_money + " Dollars per month";
                    break;
                case "2":                   
                    fuel_text = f2.fuel_money + " miles for every two months";
                    break;
                case "3":                   
                    fuel_text = f2.fuel_money + " Dollars per trimester";
                    break;
                case "4":                   
                    fuel_text = f2.fuel_money + " Dollars per semester";
                    break;
                case "5":                   
                    fuel_text = f2.fuel_money + " Dollars per year";
                    break;
            }
            break;
    }
    ...
    var maintenance_text = "<b>1/2 Maintenance</b><br>" +
                           f2.maintenance + " Dollars per year";
    
    //Repairs
    var repairs_text = "<b>Repairs and improvements<\/span></b><br>" +
                       f2.repairs + " Dollars per year";
    ...
    if(f2.type_calc_tolls == "false") {
        switch(data.tolls_period) {
            case "1":
                tolls_text += f2.tolls + " Dollars per month";
                break;
            case "2":
                tolls_text += f2.tolls + " Dollars per each two months";
                break;
            case "3":
                tolls_text += f2.tolls + " Dollars per trimester";
                break;
            case "4":
                tolls_text += f2.tolls + " Dollars per semester";
                break;
            case "5":
                tolls_text += f2.tolls + " Dollars per year";
                break;
        }
    }
    else 
        tolls_text+=f2.price_tolls_p_day + " Dollars during " + f2.tolls_days_p_month + " month";
    tolls_text += "";
    
    //Fines
    var fines_text="<b>Traffic tickets</b><br>";
    switch(data.fines_period) {
        case "1":           
            fines_text += f2.fines + " Dollars per month";
            break;
        case "2":           
            fines_text += f2.fines + " Dollars per each two months";
            break;
        case "3":           
            fines_text += f2.fines+" Dollars per trimester";
            break;
        case "4":           
            fines_text += f2.fines + " Dollars per semester";
            break;
        case "5":           
            fines_text += f2.fines + " Dollars per year";
            break;
        }
    fines_text+="";
    ...
    switch(data.washing_period) {
        case "1":
            washing_text += f2.washing + " Dollars per month";
            break;
        case "2":
            washing_text += f2.washing + " Dollars per each two months";
            break;
        case "3":
            washing_text += f2.washing +" Dollars per trimester";
            break;
        case "4":
            washing_text += f2.washing + " Dollars per semester";
            break;
        case "5":
            washing_text += f2.washing + " Dollars per year";
            break;
        }
    washing_text+="";
    ...
    varResult+= "<tr><td style=\"padding:10px 50px;\" colspan=\"2\"><b>Standing costs</b><br>" +
                "<i>Costs that don't depend on the traveled distance and those costs which must be paid even if the car is not in use</i></td></tr>";
    ...
    varResult+= "<tr><td><b>Vehicle insurance and breakdown coverage</b><br>" + insurance_text + "</td>" +
    ...
    varResult+= "<tr><td style=\"padding:10px 15px;\" colspan=\"2\"><b>Running costs</b><br>" +
                "<i>Costs that depend on the number of miles you drive</i></td></tr>";
    ...
    if((typeof data.distance_per_month) !== 'undefined' && data.distance_per_month !== 0){
        ...
        varResult+= "<tr><td><b>Running costs per mile</b></td>"+
                    "<td>&nbsp;" + currencyShow(data.running_costs_p_unit_distance.toFixed(2)) + "/mi </td></tr>";
        
        varResult+= "<tr><td class=\"border_bottom_2px\"><b>Total costs per mile</b></td>" +
                    "<td class=\"border_bottom_2px\">&nbsp;" + currencyShow(data.total_costs_p_unit_distance.toFixed(2)) + "/mi </td></tr>";
    }
...
function print_feffort_table(f1, f2, f3, data){
    ...
    if((f2.type_calc_fuel != 'km' && f3.drive_to_work == 'true') || (f2.type_calc_fuel != 'km' && f2.take_car_to_job == 'true')){   
        varResult+=  "<tr><td>You drive from home to work</td>"  +  
                     "<td>" + parseInt(f3.dist_home_job).toFixed(1) + " mi</td></tr>"+
                     ...
                     "<td>" + parseInt(f3.journey_weekend).toFixed(1) + " mi</td></tr>"+
                     "<tr><td>You drive on average per week</td>" + 
                     "<td>" + data.driving_distance.aver_drive_per_week.toFixed(1) + " mi</td></tr>";                  
    }

    varResult+=  "<tr><td>You drive per month</td>" +
                 "<td>" + data.distance_per_month.toFixed(1) + " mi</td></tr>" +
                 "<tr><td>You drive per year</td>" + 
                 "<td>" + data.driving_distance.drive_per_year.toFixed(1) + " mi</td></tr>";  
...
function print_AlternativeToCarCosts_table(f1, f2, f3, data, country){
    ...
    if(data.public_transports.display_pt()) {
        ...
        tp_text = "<b>Public transportation for your family for daily life</b><br>Number of members of your family older than 4 years old: " + 
                  f3.n_pess_familia + " person(s)" +
                  "<br>Average amount of of monthly transportation ticket pass costs per person: " + 
                  f3.monthly_pass_cost + "&#36;";
        
        if(data.public_transports.pt_carcost_ratio < data.public_transports.other_pt_ratio_threshold){
            outros_tp_text="<b>Other public transportation</b><br>Amount that was still remaining from other public transportation, for example out of your residential area, such as a long journey by trains or buses ";
        }
        taxi_text="<b>Taxi transportation<\/span><\/b><br>" + data.public_transports.km_by_taxi.toFixed(1) + " mi by paying for a taxi " + data.public_transports.taxi_price_per_km.toFixed(1) + "&#36;/mi";
    ...
    if(UBER_SWITCH){
        ...
        if (res_uber_obj){
            ...
            if(res_uber_obj.result_type==1){
                ...
                varResult+="<tr><td><b>UBER - Costs per miles</b>" + uber_url_HTML + "</td>" + 
                           "<td>" + currencyShow(res_uber_obj.ucd.toFixed(2)) + "/" + "mi</td></tr>";
                
                varResult+="<tr><td><b>UBER - Costs per minutes</b>" + uber_url_HTML + "</td>" + 
                           "<td>" + currencyShow(res_uber_obj.ucm.toFixed(2)) + "/" + "min</td></tr>";

                varResult+="<tr><td><b>Miles you drive per month</b><br></td>"+
                           "<td>" + res_uber_obj.dpm.toFixed(0) + " " +"miles</td></tr>";
                ...
                varResult+="<tr><td><b>Other public transportation</b><br>Amount that was still remaining from other public transportation, for example out of your residential area, such as a long journey by trains or buses</td>" + 
            ...
            //the case where uber equivalent is more expensive
                ...
                varResult+="<tr><td><b>Public transportation for your family for daily life</b><br>Number of members of your family older than 4 years old: " + f3.n_pess_familia + " person(s)" +
                           "<br>Average amount of of monthly transportation ticket pass costs per person: " + f3.monthly_pass_cost + "&#36;</td>" +
                ...
                varResult+="<tr><td><b>Kinetic speed</b></td>" + 
                           "<td>" + data.kinetic_speed.toFixed(2) + " " +"mi/h</td></tr>";
                           
                varResult+="<tr><td><b>UBER - miles per month</b></td>" + 
                           "<td>" + res_uber_obj.dist_uber.toFixed(0) + " " + "miles</td></tr>";
...
function print_extern_table(f1, f2, f3, data){ 
    ...
    var epa_text      = "<b>Emissões de poluentes atmosféricos</b><br>Valor aproximado: " + data.external_costs.polution + "&#36;/mi";
    var egee_text     = "<b>Emissões de gases de efeito de estufa</b><br>Valor aproximado: " + data.external_costs.ghg + "&#36;/mi";
    var ruido_text    = "<b>Poluição sonora</b><br>Valor aproximado: " + data.external_costs.noise + "&#36;/mi";
    var sr_text       = "<b>Sinistralidade rodoviária</b><br>Valor aproximado: " + data.external_costs.fatalities + "&#36;/mi";
    var cgstn_text    = "<b>Congestionamento<\/span></b><br>Valor aproximado: " + data.external_costs.congestion + "&#36;/mi";
    var ifr_estr_text = "<b>Desgaste das infraestruturas rodoviárias</b><br>Valor aproximado: " + data.external_costs.infrastr + "&#36;/mi";
    ...
    if(Country=="PT" && isDef(data.distance_per_month)){
        ...
        //header
        varResult+="<tr><td><b>Custos externos</b><br>Percorre " +(1 * data.distance_per_month).toFixed(1)+" mi/month</td>" +
                   "<td><b>Monthly amount</b></td></tr>";
        ...
        varResult+="<tr><td>" + ifr_estr_text + "</td>" + 
         ...
         //total
        varResult+="<tr><td style=\"padding:6px 10px 6px 0;\"><b>TOTAL</b></td>" +
                   "<td><b>&#36;&nbsp;"+data.external_costs.total_exter().toFixed(0)+"/month</b></td></tr>";
