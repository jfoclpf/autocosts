...
function Run2(callback){
    ...
    if(SOCIAL_SWITCH){
        $("#shareIcons").jsSocials({
            url: 'http://autocosts.info/AU',
            text: 'This calculator will allow you to find the true cost of owning a car in Australia',
            showLabel: false,
            showCount: false,
...
function print_costs_table(f1, f2, f3, data) {
    ...
    if (data.age_months === 0) {    
        ...
        depreciation_text = "<b>Depreciation of the vehicle<\/span></b>&nbsp;&nbsp;<br>Acquisition value: "+
            f1.auto_initial_cost + "A&#36;<br>Final value: "+
            f1.auto_final_cost + "A&#36;<br>Time period of ownership: "+
            data.age_months + " months<br>("+
            f1.auto_initial_cost + "A&#36;-"+
            f1.auto_final_cost + "A&#36;)/"+
    ...
    if(f1.cred_auto_s_n == "true") {
        ...
        interests_text = "<b>Loan interest</b>&nbsp;&nbsp;<br>Financed amount: " +
                         f1.credit_amount +
                         "A&#36;<br>Credit period / number of installments: " +
                         f1.credit_period +
        ...
        interests_text += "Total amount of interest paid: "+data.total_interests+"A&#36;<br>(" + data.month_cred + "*"+ f1.credit_value_p_month + ")+" + f1.credit_residual_value + "-" + f1.credit_amount;

        if(data.age_months >= data.month_cred)
            interests_text += "<br>Monthly amount spent on interest: "+data.monthly_costs.credit.toFixed(2)+"A&#36;";
        interests_text += "";
    } 
    ...
    switch(f2.type_calc_fuel){
        case "km":                     
            if (f2.take_car_to_job == "false"){
                ...
                fuel_text = fuel_text + "<br>" + "Average price of gas: " + f2.fuel_price + " A&#36;/litre&nbsp;&nbsp;";
            }
            else{
                fuel_text = f2.days_p_week + " Day(s) per week you drive to work <br>";
                fuel_text = fuel_text + "You drive " + f2.distance_home2job + " kilometres between home and the workplace <br>";
                fuel_text = fuel_text + "You drive " + f2.distance_weekend + " kilometres on average during the days you don't take your car to the workplace&nbsp;<br>";
                fuel_text = fuel_text + "Total mileage driven on average " + data.distance_per_month.toFixed(1) + " km per month (~30.5 days) <br>";
                fuel_text = fuel_text + "Fuel efficiency of your vehicle: " + f2.car_consumption + " l/100km";
                fuel_text = fuel_text + "<br>" + "Average price you pay for fuel/gas: " + f2.fuel_price + " A&#36;/litre";
            }
            break;
        case "euros":
    ...
    //Fines
    var fines_text="<b>Traffic fines</b><br>";
    ...
    if((typeof data.distance_per_month) !== 'undefined' && data.distance_per_month !== 0){
        ...
        varResult+= "<tr><td><b>Running costs per kilometre</b></td>"+
                    "<td>&nbsp;" + currencyShow(data.running_costs_p_unit_distance.toFixed(2)) + "/km </td></tr>";
        
        varResult+= "<tr><td class=\"border_bottom_2px\"><b>Total costs per kilometre</b></td>" +
...
function print_AlternativeToCarCosts_table(f1, f2, f3, data, country){
    ...
    if(data.public_transports.display_pt()) {
        ...
        taxi_text="<b>Taxi transportation<\/span><\/b><br>" + data.public_transports.km_by_taxi.toFixed(1) + " km by paying for a taxi " + data.public_transports.taxi_price_per_km.toFixed(1) + "A&#36;/km";
        ...
        if (res_uber_obj){
            ...
            //the case where uber equivalent is more expensive
                ...
                varResult+="<tr><td><b>Public transportation for your family for daily life</b><br>Number of members of your family older than 4 years old: " + f3.n_pess_familia + " person(s)" +
                           "<br>Average amount of of monthly transportation ticket pass costs per person: " + f3.monthly_pass_cost + "A&#36;</td>" +
...
function print_extern_table(f1, f2, f3, data){ 
    ...
    var epa_text      = "<b>Emissões de poluentes atmosféricos</b><br>Valor aproximado: " + data.external_costs.polution + "A&#36;/km";
    var egee_text     = "<b>Emissões de gases de efeito de estufa</b><br>Valor aproximado: " + data.external_costs.ghg + "A&#36;/km";
    var ruido_text    = "<b>Poluição sonora</b><br>Valor aproximado: " + data.external_costs.noise + "A&#36;/km";
    var sr_text       = "<b>Sinistralidade rodoviária</b><br>Valor aproximado: " + data.external_costs.fatalities + "A&#36;/km";
    var cgstn_text    = "<b>Congestionamento<\/span></b><br>Valor aproximado: " + data.external_costs.congestion + "A&#36;/km";
    var ifr_estr_text = "<b>Desgaste das infraestruturas rodoviárias</b><br>Valor aproximado: " + data.external_costs.infrastr + "A&#36;/km";
    ...
    if(Country=="PT" && isDef(data.distance_per_month)){
        ...
        varResult+="<tr><td>" + epa_text + "</td>" +   
                   "<td>&nbsp;A&#36; " + (data.external_costs.polution * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + egee_text + "</td>" + 
                   "<td>&nbsp;A&#36; " + (data.external_costs.ghg * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + ruido_text + "</td>" + 
                   "<td>&nbsp;A&#36; " + (data.external_costs.noise * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + sr_text + "</td>" + 
                   "<td>&nbsp;A&#36; " + (data.external_costs.fatalities * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + cgstn_text + "</td>" + 
                   "<td>&nbsp;A&#36; " + (data.external_costs.congestion * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + ifr_estr_text + "</td>" + 
                   "<td>&nbsp;A&#36; " + (data.external_costs.infrastr * data.distance_per_month).toFixed(1)+"</td></tr>";
        
         //total
        varResult+="<tr><td style=\"padding:6px 10px 6px 0;\"><b>TOTAL</b></td>" +
                   "<td><b>A&#36;&nbsp;"+data.external_costs.total_exter().toFixed(0)+"/month</b></td></tr>";
