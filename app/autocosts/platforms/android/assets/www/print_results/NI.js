...
function Run2(callback){
    ...
    if(SOCIAL_SWITCH){
        $("#shareIcons").jsSocials({
            url: 'http://autocostos.info/NI',
            text: 'Esta calculadora te permitirá conocer el verdadero costo de ser propietario de un vehículo en Nicaragua',
            showLabel: false,
            showCount: false,
...
function print_costs_table(f1, f2, f3, data) {
    ...
    if (data.age_months === 0) {    
        ...
        depreciation_text = "<b>Depreciación del vehículo<\/span></b>&nbsp;&nbsp;<br>Precio de compra: "+
            f1.auto_initial_cost + "C&#36;<br>Precio de hoy: "+
            f1.auto_final_cost + "C&#36;<br>Periodo de posesión: "+
    ...
    {
        case "semestral":
            insurance_text = f1.insurance_value + " Córdobas por semestre";
            break;
        case "anual":
            insurance_text = f1.insurance_value + " Córdobas por año";
            break;
        case "mensal":
            insurance_text = data.monthly_costs.insurance + " Córdobas por mes";
            break;
        case "trimestral":
            insurance_text = f1.insurance_value + " Córdobas por trimestre";
            break;
    }
    ...
    if(f1.cred_auto_s_n == "true") {
        ...
        interests_text = "<b>Intereses del préstamo</b>&nbsp;&nbsp;<br>Cuota financiada: " +
                         f1.credit_amount +
                         "C&#36;<br>Periodo de crédito / cantidad de cuotas: " +
                         f1.credit_period +
        ...
        interests_text += "Importe total de intereses: "+data.total_interests+"C&#36;<br>(" + data.month_cred + "*"+ f1.credit_value_p_month + ")+" + f1.credit_residual_value + "-" + f1.credit_amount;

        if(data.age_months >= data.month_cred)
            interests_text += "<br>Cuota mensual de intereses: "+data.monthly_costs.credit.toFixed(2)+"C&#36;";
        interests_text += "";
    } 
    ...
    if (f1.nmr_times_inspec !== 0){
        inspection_text = "<b>Inspección técnico-mecánica y de emisión de gases</b><br>" +
                          f1.nmr_times_inspec +
                          " veces, costando " +
                          f1.inspec_price +
                          " C&#36; cada una durante " +
    ...
    switch(f2.type_calc_fuel){
        case "km":                     
            if (f2.take_car_to_job == "false"){
                ...
                fuel_text = fuel_text + "<br>" + "Precio medio del combustible: " + f2.fuel_price + " C&#36;/l&nbsp;&nbsp;";
            }
            else{
                ...
                fuel_text = fuel_text + "<br>" + "Gasto promedio en combustible: " + f2.fuel_price + " C&#36;/l";
            }
            break;
        case "euros":
            ...
            {
                case "1":
                    fuel_text = f2.fuel_money + " Córdobas por mes";
                    break;
                case "2":                   
                    fuel_text = f2.fuel_money + " kilómetros por bimestre";
                    break;
                case "3":                   
                    fuel_text = f2.fuel_money + " Córdobas por trimestre";
                    break;
                case "4":                   
                    fuel_text = f2.fuel_money + " Córdobas por semestre";
                    break;
                case "5":                   
                    fuel_text = f2.fuel_money + " Córdobas por año";
                    break;
            }
            break;
    }
    ...
    var maintenance_text = "<b>1/2 Mantenimiento</b><br>" +
                           f2.maintenance + " Córdobas por año";
    
    //Repairs
    var repairs_text = "<b>Reparaciones y mejoras<\/span></b><br>" +
                       f2.repairs + " Córdobas por año";
    ...
    if(f2.type_calc_tolls == "false") {
        switch(data.tolls_period) {
            case "1":
                tolls_text += f2.tolls + " Córdobas por mes";
                break;
            case "2":
                tolls_text += f2.tolls + " Córdobas por cada bimestre";
                break;
            case "3":
                tolls_text += f2.tolls + " Córdobas por trimestre";
                break;
            case "4":
                tolls_text += f2.tolls + " Córdobas por semestre";
                break;
            case "5":
                tolls_text += f2.tolls + " Córdobas por año";
                break;
        }
    }
    else 
        tolls_text+=f2.price_tolls_p_day + " Córdobas durante " + f2.tolls_days_p_month + " mes";
    tolls_text += "";
    ...
    switch(data.fines_period) {
        case "1":           
            fines_text += f2.fines + " Córdobas por mes";
            break;
        case "2":           
            fines_text += f2.fines + " Córdobas por cada bimestre";
            break;
        case "3":           
            fines_text += f2.fines+" Córdobas por trimestre";
            break;
        case "4":           
            fines_text += f2.fines + " Córdobas por semestre";
            break;
        case "5":           
            fines_text += f2.fines + " Córdobas por año";
            break;
        }
    fines_text+="";
    ...
    switch(data.washing_period) {
        case "1":
            washing_text += f2.washing + " Córdobas por mes";
            break;
        case "2":
            washing_text += f2.washing + " Córdobas por cada bimestre";
            break;
        case "3":
            washing_text += f2.washing +" Córdobas por trimestre";
            break;
        case "4":
            washing_text += f2.washing + " Córdobas por semestre";
            break;
        case "5":
            washing_text += f2.washing + " Córdobas por año";
            break;
        }
    washing_text+="";
    ...
    varResult+= "<tr><td><b>Seguro de responsabilidad civil por daños a terceros</b><br>" + insurance_text + "</td>" +
...
function print_feffort_table(f1, f2, f3, data){
    ...
    varResult+= "<tr><td colspan=\"2\"><b>Esfuerzo financiero" +
                ': ' + (data.total_costs_year/data.fin_effort.income_per_year*100).toFixed(0) + 
                '&#37;</b>' +
                "<tr><td>Gasto anual total por el vehículo</td>" + 
...
function print_AlternativeToCarCosts_table(f1, f2, f3, data, country){
    ...
    if(data.public_transports.display_pt()) {
        ...
        taxi_text="<b>Transporte en taxi<\/span><\/b><br>" + data.public_transports.km_by_taxi.toFixed(1) + " km en taxi pagando " + data.public_transports.taxi_price_per_km.toFixed(1) + "C&#36;/km";
        ...
        if (res_uber_obj){
            ...
            //the case where uber equivalent is more expensive
                ...
                varResult+="<tr><td><b>Transporte público en la vida diaria de tu familia</b><br>Cantidad de miembros de tu familia mayores de 4 años: " + f3.n_pess_familia + " persona(s)" +
                           "<br>Promedio de gastos en el abono mensual por persona: " + f3.monthly_pass_cost + "C&#36;</td>" +
...
function print_extern_table(f1, f2, f3, data){ 
    ...
    if(Country=="PT" && isDef(data.distance_per_month)){
        ...
        varResult+="<tr><td>" + ifr_estr_text + "</td>" + 
         ...
         //total
        varResult+="<tr><td style=\"padding:6px 10px 6px 0;\"><b>TOTAL</b></td>" +
                   "<td><b>C&#36;&nbsp;"+data.external_costs.total_exter().toFixed(0)+"/mes</b></td></tr>";
