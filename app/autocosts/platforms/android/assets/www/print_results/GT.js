...
function Run2(callback){
    ...
    if(SOCIAL_SWITCH){
        $("#shareIcons").jsSocials({
            url: 'http://autocostos.info/GT',
            text: 'Esta calculadora te permitirá conocer el verdadero costo de ser propietario de un auto en Guatemala',
            showLabel: false,
            showCount: false,
...
function print_main_table(f1, f2, f3, data) {
    ...
    //header
    varResult+= '<tr><td style="padding:7px;" colspan="4"><b>TU AUTO CUESTA</b></td></tr>';
...
function print_costs_table(f1, f2, f3, data) {
    ...
    if (data.age_months === 0) {    
        ...
        depreciation_text = "<b>Depreciación del vehículo<\/span></b>&nbsp;&nbsp;<br>Precio de compra: "+
            f1.auto_initial_cost + "Q<br>Precio de hoy: "+
            f1.auto_final_cost + "Q<br>Periodo de posesión: "+
            data.age_months + " meses<br>("+
            f1.auto_initial_cost + "Q-"+
            f1.auto_final_cost + "Q)/"+
    ...
    {
        case "semestral":
            insurance_text = f1.insurance_value + " Quetzales por semestre";
            break;
        case "anual":
            insurance_text = f1.insurance_value + " Quetzales por año";
            break;
        case "mensal":
            insurance_text = data.monthly_costs.insurance + " Quetzales por mes";
            break;
        case "trimestral":
            insurance_text = f1.insurance_value + " Quetzales por trimestre";
            break;
    }
    ...
    if(f1.cred_auto_s_n == "true") {
        ...
        interests_text = "<b>Intereses del préstamo</b>&nbsp;&nbsp;<br>Cuota financiada: " +
                         f1.credit_amount +
                         "Q<br>Periodo de crédito / número de plazos: " +
                         f1.credit_period +
        ...
        interests_text += "Importe total de intereses: "+data.total_interests+"Q<br>(" + data.month_cred + "*"+ f1.credit_value_p_month + ")+" + f1.credit_residual_value + "-" + f1.credit_amount;

        if(data.age_months >= data.month_cred)
            interests_text += "<br>Cuota mensual de intereses: "+data.monthly_costs.credit.toFixed(2)+"Q";
        interests_text += "";
    } 
    ...
    if (f1.nmr_times_inspec !== 0){
        inspection_text = "<b>Inspección Técnica del Vehículo (ITV)</b><br>" +
                          f1.nmr_times_inspec +
                          " veces costando " +
                          f1.inspec_price +
                          " Q cada uno durante " +
            ...
            if (f2.take_car_to_job == "false"){
                switch(data.fuel_period_km)
                {
                    case "1":
                        ...
                        break;
                    case "2":                   
                        fuel_text = f2.distance + " kilómetros por cada dos meses";
                        break;
                    case "3":                   
                ...
                fuel_text = fuel_text + "<br>" + "Eficacia del combustible de tu auto: " + f2.car_consumption + " km/g&nbsp;";
                fuel_text = fuel_text + "<br>" + "Precio medio del combustible: " + f2.fuel_price + " Q/G&nbsp;&nbsp;";
            }
            else{
                fuel_text = f2.days_p_week + " día(s) por semana que vas al trabajo en auto <br>";
                fuel_text = fuel_text + "Conduces " + f2.distance_home2job + " kilómetros entre tu casa y el lugar del trabajo <br>";
                fuel_text = fuel_text + "Conduces " + f2.distance_weekend + " kilómetros promedio de los días que no utilizas el auto para ir al trabajar&nbsp;<br>";
                fuel_text = fuel_text + "Conduces una media de " + data.distance_per_month.toFixed(1) + " km por mes (~30.5 días) <br>";
                fuel_text = fuel_text + "Eficacia del combustible de tu auto: " + f2.car_consumption + " km/g";
                fuel_text = fuel_text + "<br>" + "Gasto promedio por el combustible: " + f2.fuel_price + " Q/G";
            }
            break;
        case "euros":
            ...
            {
                case "1":
                    fuel_text = f2.fuel_money + " Quetzales por mes";
                    break;
                case "2":                   
                    fuel_text = f2.fuel_money + " kilómetros por cada dos meses";
                    break;
                case "3":                   
                    fuel_text = f2.fuel_money + " Quetzales por trimestre";
                    break;
                case "4":                   
                    fuel_text = f2.fuel_money + " Quetzales por semestre";
                    break;
                case "5":                   
                    fuel_text = f2.fuel_money + " Quetzales por año";
                    break;
            }
            break;
    }
    ...
    var maintenance_text = "<b>1/2 Mantenimiento</b><br>" +
                           f2.maintenance + " Quetzales por año";
    
    //Repairs
    var repairs_text = "<b>Reparaciones y mejoras<\/span></b><br>" +
                       f2.repairs + " Quetzales por año";
    ...
    if(f2.type_calc_tolls == "false") {
        switch(data.tolls_period) {
            case "1":
                tolls_text += f2.tolls + " Quetzales por mes";
                break;
            case "2":
                tolls_text += f2.tolls + " Quetzales por cada dos meses";
                break;
            case "3":
                tolls_text += f2.tolls + " Quetzales por trimestre";
                break;
            case "4":
                tolls_text += f2.tolls + " Quetzales por semestre";
                break;
            case "5":
                tolls_text += f2.tolls + " Quetzales por año";
                break;
        }
    }
    else 
        tolls_text+=f2.price_tolls_p_day + " Quetzales durante " + f2.tolls_days_p_month + " mes";
    tolls_text += "";
    ...
    switch(data.fines_period) {
        case "1":           
            fines_text += f2.fines + " Quetzales por mes";
            break;
        case "2":           
            fines_text += f2.fines + " Quetzales por cada dos meses";
            break;
        case "3":           
            fines_text += f2.fines+" Quetzales por trimestre";
            break;
        case "4":           
            fines_text += f2.fines + " Quetzales por semestre";
            break;
        case "5":           
            fines_text += f2.fines + " Quetzales por año";
            break;
        }
    fines_text+="";
    ...
    switch(data.washing_period) {
        case "1":
            washing_text += f2.washing + " Quetzales por mes";
            break;
        case "2":
            washing_text += f2.washing + " Quetzales por cada dos meses";
            break;
        case "3":
            washing_text += f2.washing +" Quetzales por trimestre";
            break;
        case "4":
            washing_text += f2.washing + " Quetzales por semestre";
            break;
        case "5":
            washing_text += f2.washing + " Quetzales por año";
            break;
        }
    washing_text+="";
    ...
    varResult+= "<tr><td style=\"padding:10px 50px;\" colspan=\"2\"><b>Gastos fijos</b><br>" +
                "<i>Gastos que no dependen de la distancia recorrida y que tienen que pagarse incluso si el auto está parado</i></td></tr>";
    ...
    varResult+= "<tr><td><b>Seguro de vehículo</b><br>" + insurance_text + "</td>" +
...
function print_feffort_table(f1, f2, f3, data){
    ...
    switch(f3.income_type){
        case 'year':    
            varResult+= "<tr><td>Ingresos netos año</td>" + 
            ...
            break;
        case 'month':
            varResult+= "<tr><td>Ingresos netos mes</td>" + 
                        "<td style=\"width:20%\">" + currencyShow(data.fin_effort.income) + "</td></tr>" +
                        "<tr><td>Número de meses de ingresos por año</td>" + 
            ...
            break;
        case 'week':
            varResult+= "<tr><td>Ingresos netos semana</td>" + 
                        "<td style=\"width:20%\">" + currencyShow(data.fin_effort.income) + "</td></tr>"+
                        "<tr><td>Número de semanas de ingresos por año</td>" + 
                        "<td>" + data.fin_effort.income_per_type + "</td></tr>" +
                        "<tr><td>Ingresos medios netos por mes</td>" + 
                        "<td>" + currencyShow(data.fin_effort.aver_income_per_month.toFixed(1)) + "</td></tr>"+
                        "<tr><td>Ingresos medios netos por año</td>" + 
            ...
            break;  
        case 'hour':
            varResult+= "<tr><td>Ingresos netos hora</td>" + 
                        "<td style=\"width:20%\">" + currencyShow(data.fin_effort.income) + "</td></tr>"+
                        "<tr><td>Número de horas de ingresos por semana</td>" + 
    ...
    if((f2.type_calc_fuel != 'km' && f3.drive_to_work == 'true') || (f2.type_calc_fuel != 'km' && f2.take_car_to_job == 'true')){   
        varResult+=  "<tr><td>Conduces de casa al trabajo</td>"  +  
                     ...
                     "<tr><td>Número de días semanales que vas en coche a trabajar</td>"  +  
                     "<td>" + f3.drive_to_work_days_per_week + " días</td></tr>" +
                     "<tr><td>La distancia que recorres los días que no vas en auto a trabajar</td>" + 
    ...
    if(f3.drive_to_work == 'true' || f2.take_car_to_job == 'true'){
        varResult+= "<tr><td>Número de minutos que manejas para llegar de casa al trabajo</td>" + 
                    "<td>" + f3.time_home_job + " min</td></tr>" +
                    "<tr><td>Número de días por semana que vas en auto al trabajo</td>" + 
                    "<td>" + f3.drive_to_work_days_per_week + " días</td></tr>" +
                    "<tr><td>Número de minutos empleados en conducción los días que no vas en auto al trabajo</td>" + 
                    "<td>" + f3.time_weekend + " min</td></tr>" +
                    "<tr><td>Número de minutos que manejas por semana</td>" + 
                    "<td>" + data.time_spent_driving.min_drive_per_week + " min</td></tr>";
    }
    else{
        varResult+= "<tr><td>Número de minutos que manejas por día</td>" + 
                    "<td>" + f3.min_drive_per_day + " min</td></tr>" +
                    "<tr><td>Número de días mensuales que manejas</td>" + 
                    "<td>" + f3.days_drive_per_month + " días</td></tr>";
    }

    varResult+= "<tr><td>Número de horas por mes</td>" + 
                "<td>" + data.time_spent_driving.hours_drive_per_month.toFixed(1) + " h</td></tr>"+
                "<tr><td>Número de horas por año</td>" + 
    ...
    varResult+= "<tr><td colspan=\"2\"><b>Esfuerzo financiero" +
                ...
                "<tr><td>Número de horas al año que debes trabajar para pagar por el auto</td>"  +  
                "<td>" + data.fin_effort.hours_per_year_to_afford_car.toFixed(1) + " h</td></tr>"+
                "<tr><td>Número de meses al año que debes trabajar para pagar por el auto</td>" +  
                "<td>" + data.fin_effort.month_per_year_to_afford_car.toFixed(2)+"</td></tr>"+
                "<tr><td>¿Por cuántos días, después del 1 de enero, el auto ya está pagado?</td>" +  
...
function print_AlternativeToCarCosts_table(f1, f2, f3, data, country){
    ...
    if(data.public_transports.display_pt()) {
        ...
        tp_text = "<b>Transporte público en la vida diaria de tu familia</b><br>Número de miembros de tu familia mayores de 4 años: " + 
                  f3.n_pess_familia + " persona(s)" +
                  "<br>Promedio de gastos en el abono mensual por persona: " + 
                  f3.monthly_pass_cost + "Q";
        
        if(data.public_transports.pt_carcost_ratio < data.public_transports.other_pt_ratio_threshold){
            outros_tp_text="<b>Otros transportes públicos</b><br>Cuota que pagaste por otro tipo de transporte público fuera de tu zona, como para viajes en trenes y buses de largo recorrido ";
        }
        taxi_text="<b>Transporte en taxi<\/span><\/b><br>" + data.public_transports.km_by_taxi.toFixed(1) + " km en taxi pagando " + data.public_transports.taxi_price_per_km.toFixed(1) + "Q/km";
    ...
    if(UBER_SWITCH){
        ...
        if (res_uber_obj){
            ...
            if(res_uber_obj.result_type==1){
                ...
                varResult+="<tr><td><b>Número de minutos que manejas por mes</b></td>" + 
                ...
                varResult+="<tr><td><b>Otros transportes públicos</b><br>Cuota que pagaste por otro tipo de transporte público fuera de tu zona, como para viajes en trenes y buses de largo recorrido</td>" + 
            ...
            //the case where uber equivalent is more expensive
                ...
                varResult+="<tr><td><b>Transporte público en la vida diaria de tu familia</b><br>Número de miembros de tu familia mayores de 4 años: " + f3.n_pess_familia + " persona(s)" +
                           "<br>Promedio de gastos en el abono mensual por persona: " + f3.monthly_pass_cost + "Q</td>" +
...
function print_extern_table(f1, f2, f3, data){ 
    ...
    var epa_text      = "<b>Emissões de poluentes atmosféricos</b><br>Valor aproximado: " + data.external_costs.polution + "Q/km";
    var egee_text     = "<b>Emissões de gases de efeito de estufa</b><br>Valor aproximado: " + data.external_costs.ghg + "Q/km";
    var ruido_text    = "<b>Poluição sonora</b><br>Valor aproximado: " + data.external_costs.noise + "Q/km";
    var sr_text       = "<b>Sinistralidade rodoviária</b><br>Valor aproximado: " + data.external_costs.fatalities + "Q/km";
    var cgstn_text    = "<b>Congestionamento<\/span></b><br>Valor aproximado: " + data.external_costs.congestion + "Q/km";
    var ifr_estr_text = "<b>Desgaste das infraestruturas rodoviárias</b><br>Valor aproximado: " + data.external_costs.infrastr + "Q/km";
    ...
    if(Country=="PT" && isDef(data.distance_per_month)){
        ...
        varResult+="<tr><td>" + epa_text + "</td>" +   
                   "<td>&nbsp;Q " + (data.external_costs.polution * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + egee_text + "</td>" + 
                   "<td>&nbsp;Q " + (data.external_costs.ghg * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + ruido_text + "</td>" + 
                   "<td>&nbsp;Q " + (data.external_costs.noise * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + sr_text + "</td>" + 
                   "<td>&nbsp;Q " + (data.external_costs.fatalities * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + cgstn_text + "</td>" + 
                   "<td>&nbsp;Q " + (data.external_costs.congestion * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + ifr_estr_text + "</td>" + 
                   "<td>&nbsp;Q " + (data.external_costs.infrastr * data.distance_per_month).toFixed(1)+"</td></tr>";
        
         //total
        varResult+="<tr><td style=\"padding:6px 10px 6px 0;\"><b>TOTAL</b></td>" +
                   "<td><b>Q&nbsp;"+data.external_costs.total_exter().toFixed(0)+"/mes</b></td></tr>";
