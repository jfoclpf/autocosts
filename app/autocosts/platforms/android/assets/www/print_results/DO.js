...
function Run2(callback){
    ...
    if(SOCIAL_SWITCH){
        $("#shareIcons").jsSocials({
            url: 'http://autocostos.info/DO',
            text: 'Esta calculadora te permitirá conocer el verdadero costo de ser propietario de un vehículo en República Dominicana',
            showLabel: false,
            showCount: false,
...
function print_costs_table(f1, f2, f3, data) {
    ...
    if (data.age_months === 0) {    
        ...
        depreciation_text = "<b>Depreciación del vehículo<\/span></b>&nbsp;&nbsp;<br>Precio de compra: "+
            f1.auto_initial_cost + "RD&#36;<br>Precio de hoy: "+
            f1.auto_final_cost + "RD&#36;<br>Periodo de posesión: "+
            data.age_months + " meses<br>("+
            f1.auto_initial_cost + "RD&#36;-"+
            f1.auto_final_cost + "RD&#36;)/"+
    ...
    if(f1.cred_auto_s_n == "true") {
        ...
        interests_text = "<b>Intereses del préstamo</b>&nbsp;&nbsp;<br>Cuota financiada: " +
                         f1.credit_amount +
                         "RD&#36;<br>Periodo de crédito / cantidad de cuotas: " +
                         f1.credit_period +
                         " meses<br>Valor promedio mensual: " +
                         f1.credit_value_p_month +
                         "RD&#36;<br>Valor residual: " +
                         f1.credit_residual_value +
                         "RD&#36;<br>";    

        interests_text += "Importe total de intereses: "+data.total_interests+"RD&#36;<br>(" + data.month_cred + "*"+ f1.credit_value_p_month + ")+" + f1.credit_residual_value + "-" + f1.credit_amount;

        if(data.age_months >= data.month_cred)
            interests_text += "<br>Cuota mensual de intereses: "+data.monthly_costs.credit.toFixed(2)+"RD&#36;";
        interests_text += "";
    } 
    ...
    if (f1.nmr_times_inspec !== 0){
        inspection_text = "<b>Inspección Técnica Vehicular (ITV)</b><br>" +
                          f1.nmr_times_inspec +
                          " veces, costando " +
                          f1.inspec_price +
                          " RD&#36; cada una durante " +
    ...
    //Taxes
    var cartax_text = "<b>Impuesto de Circulación de Vehículos (ICV)</b><br>" +
    ...
    switch(f2.type_calc_fuel){
        case "km":                     
            if (f2.take_car_to_job == "false"){
                ...
                fuel_text = fuel_text + "<br>" + "Precio medio del combustible: " + f2.fuel_price + " RD&#36;/l&nbsp;&nbsp;";
            }
            else{
                ...
                fuel_text = fuel_text + "<br>" + "Gasto promedio en combustible: " + f2.fuel_price + " RD&#36;/l";
            }
            break;
        case "euros":
    ...
    if(f2.type_calc_tolls == "false") {
        switch(data.tolls_period) {
            case "1":
                ...
                break;
            case "2":
                tolls_text += f2.tolls + " Pesos por cada bimestre";
                break;
            case "3":
    ...
    switch(data.fines_period) {
        case "1":           
            ...
            break;
        case "2":           
            fines_text += f2.fines + " Pesos por cada bimestre";
            break;
        case "3":           
    ...
    switch(data.washing_period) {
        case "1":
            ...
            break;
        case "2":
            washing_text += f2.washing + " Pesos por cada bimestre";
            break;
        case "3":
    ...
    varResult+= "<tr><td><b>Seguro del vehículo</b><br>" + insurance_text + "</td>" +
...
function print_AlternativeToCarCosts_table(f1, f2, f3, data, country){
    ...
    if(data.public_transports.display_pt()) {
        ...
        taxi_text="<b>Transporte en taxi<\/span><\/b><br>" + data.public_transports.km_by_taxi.toFixed(1) + " km en taxi pagando " + data.public_transports.taxi_price_per_km.toFixed(1) + "RD&#36;/km";
        ...
        if (res_uber_obj){
            ...
            //the case where uber equivalent is more expensive
                ...
                varResult+="<tr><td><b>Transporte público en la vida diaria de tu familia</b><br>Cantidad de miembros de tu familia mayores de 4 años: " + f3.n_pess_familia + " persona(s)" +
                           "<br>Promedio de gastos en el abono mensual por persona: " + f3.monthly_pass_cost + "RD&#36;</td>" +
...
function print_extern_table(f1, f2, f3, data){ 
    ...
    var epa_text      = "<b>Emissões de poluentes atmosféricos</b><br>Valor aproximado: " + data.external_costs.polution + "RD&#36;/km";
    var egee_text     = "<b>Emissões de gases de efeito de estufa</b><br>Valor aproximado: " + data.external_costs.ghg + "RD&#36;/km";
    var ruido_text    = "<b>Poluição sonora</b><br>Valor aproximado: " + data.external_costs.noise + "RD&#36;/km";
    var sr_text       = "<b>Sinistralidade rodoviária</b><br>Valor aproximado: " + data.external_costs.fatalities + "RD&#36;/km";
    var cgstn_text    = "<b>Congestionamento<\/span></b><br>Valor aproximado: " + data.external_costs.congestion + "RD&#36;/km";
    var ifr_estr_text = "<b>Desgaste das infraestruturas rodoviárias</b><br>Valor aproximado: " + data.external_costs.infrastr + "RD&#36;/km";
    ...
    if(Country=="PT" && isDef(data.distance_per_month)){
        ...
        varResult+="<tr><td>" + epa_text + "</td>" +   
                   "<td>&nbsp;RD&#36; " + (data.external_costs.polution * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + egee_text + "</td>" + 
                   "<td>&nbsp;RD&#36; " + (data.external_costs.ghg * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + ruido_text + "</td>" + 
                   "<td>&nbsp;RD&#36; " + (data.external_costs.noise * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + sr_text + "</td>" + 
                   "<td>&nbsp;RD&#36; " + (data.external_costs.fatalities * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + cgstn_text + "</td>" + 
                   "<td>&nbsp;RD&#36; " + (data.external_costs.congestion * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + ifr_estr_text + "</td>" + 
                   "<td>&nbsp;RD&#36; " + (data.external_costs.infrastr * data.distance_per_month).toFixed(1)+"</td></tr>";
        
         //total
        varResult+="<tr><td style=\"padding:6px 10px 6px 0;\"><b>TOTAL</b></td>" +
                   "<td><b>RD&#36;&nbsp;"+data.external_costs.total_exter().toFixed(0)+"/mes</b></td></tr>";
