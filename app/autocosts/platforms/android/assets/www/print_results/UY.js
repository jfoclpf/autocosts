...
function Run2(callback){
    ...
    if(SOCIAL_SWITCH){
        $("#shareIcons").jsSocials({
            url: 'http://autocostos.info/UY',
            text: 'Esta calculadora te permitirá conocer el verdadero costo de ser propietario de un vehículo en Uruguay',
            showLabel: false,
            showCount: false,
...
function print_costs_table(f1, f2, f3, data) {
    ...
    {
        case "semestral":
            insurance_text = f1.insurance_value + " Pesos Uruguayos por semestre";
            break;
        case "anual":
            insurance_text = f1.insurance_value + " Pesos Uruguayos por año";
            break;
        case "mensal":
            insurance_text = data.monthly_costs.insurance + " Pesos Uruguayos por mes";
            break;
        case "trimestral":
            insurance_text = f1.insurance_value + " Pesos Uruguayos por trimestre";
            break;
    }
    ...
    if (f1.nmr_times_inspec !== 0){
        inspection_text = "<b>Inspección Técnica Vehícular (ITV)</b><br>" +
                          f1.nmr_times_inspec +
                          " veces, costando " +
                          f1.inspec_price +
                          " &#36; cada una durante " +
    ...
    var cartax_text = "<b>Impuestos del vehículo</b><br>" +
                      f1.car_tax + " Pesos Uruguayos por año";
    ...
    switch(f2.type_calc_fuel){
        case "km":                     
            if (f2.take_car_to_job == "false"){
                ...
                fuel_text = fuel_text + "Conduces " + f2.distance_weekend + " kilómetros en promedio, los días que no utilizas el vehículo para ir a trabajar&nbsp;<br>";
        ...
        case "euros":
            ...
            {
                case "1":
                    fuel_text = f2.fuel_money + " Pesos Uruguayos por mes";
                    break;
                case "2":                   
                    fuel_text = f2.fuel_money + " kilómetros por bimestre";
                    break;
                case "3":                   
                    fuel_text = f2.fuel_money + " Pesos Uruguayos por trimestre";
                    break;
                case "4":                   
                    fuel_text = f2.fuel_money + " Pesos Uruguayos por semestre";
                    break;
                case "5":                   
                    fuel_text = f2.fuel_money + " Pesos Uruguayos por año";
                    break;
            }
            break;
    }
    ...
    var maintenance_text = "<b>1/2 Mantenimiento</b><br>" +
                           f2.maintenance + " Pesos Uruguayos por año";
    
    //Repairs
    var repairs_text = "<b>Reparaciones y mejoras<\/span></b><br>" +
                       f2.repairs + " Pesos Uruguayos por año";
    ...
    if(f2.type_calc_tolls == "false") {
        switch(data.tolls_period) {
            case "1":
                tolls_text += f2.tolls + " Pesos Uruguayos por mes";
                break;
            case "2":
                tolls_text += f2.tolls + " Pesos Uruguayos cada bimestre";
                break;
            case "3":
                tolls_text += f2.tolls + " Pesos Uruguayos por trimestre";
                break;
            case "4":
                tolls_text += f2.tolls + " Pesos Uruguayos por semestre";
                break;
            case "5":
                tolls_text += f2.tolls + " Pesos Uruguayos por año";
                break;
        }
    }
    else 
        tolls_text+=f2.price_tolls_p_day + " Pesos Uruguayos durante " + f2.tolls_days_p_month + " mes";
    tolls_text += "";
    ...
    switch(data.fines_period) {
        case "1":           
            fines_text += f2.fines + " Pesos Uruguayos por mes";
            break;
        case "2":           
            fines_text += f2.fines + " Pesos Uruguayos cada bimestre";
            break;
        case "3":           
            fines_text += f2.fines+" Pesos Uruguayos por trimestre";
            break;
        case "4":           
            fines_text += f2.fines + " Pesos Uruguayos por semestre";
            break;
        case "5":           
            fines_text += f2.fines + " Pesos Uruguayos por año";
            break;
        }
    fines_text+="";
    ...
    switch(data.washing_period) {
        case "1":
            washing_text += f2.washing + " Pesos Uruguayos por mes";
            break;
        case "2":
            washing_text += f2.washing + " Pesos Uruguayos cada bimestre";
            break;
        case "3":
            washing_text += f2.washing +" Pesos Uruguayos por trimestre";
            break;
        case "4":
            washing_text += f2.washing + " Pesos Uruguayos por semestre";
            break;
        case "5":
            washing_text += f2.washing + " Pesos Uruguayos por año";
            break;
        }
    washing_text+="";
    ...
    varResult+= "<tr><td><b>Seguro de vehículo y SOA</b><br>" + insurance_text + "</td>" +
...
function print_feffort_table(f1, f2, f3, data){
    ...
    if((f2.type_calc_fuel != 'km' && f3.drive_to_work == 'true') || (f2.type_calc_fuel != 'km' && f2.take_car_to_job == 'true')){   
        varResult+=  "<tr><td>Conduces de casa al trabajo</td>"  +  
                     ...
                     "<tr><td>Cantidad de días semanales que vas en vehículo a trabajar</td>"  +  
                     "<td>" + f3.drive_to_work_days_per_week + " días</td></tr>" +
                     "<tr><td>Distancia que recorres los días que no vas en vehículo a trabajar</td>" + 
    ...
    if(f3.drive_to_work == 'true' || f2.take_car_to_job == 'true'){
        ...
        varResult+= "<tr><td>Cantidad de minutos que manejas por día</td>" + 
                    ...
                    "<tr><td>Cantidad de días que manejas por mes</td>" + 
