...
function Run2(callback){
    ...
    if(SOCIAL_SWITCH){
        $("#shareIcons").jsSocials({
            url: 'http://autocosts.info/IN',
            text: 'यह कॅलक्यूलेटर आपको, भारत में,आपकी गाड़ी से जुड़ी सारे खर्च जानने में मदद करेगा',
            showLabel: false,
            showCount: false,
...
function print_result_final_text(data){
    ...
    if(data.total_costs_month >= 150 && data.age_months > 6) {
        ...
        var text_msg = '<div>लागत के इस स्तर के साथ, आपकी गाड़ी के  '+
                       '<b>' + data.age_months + '</b> महीनों के मालिकी में पहले ही आपने खर्च किए हैं:</div>'+
...
function print_costs_table(f1, f2, f3, data) {
    ...
    if (data.age_months === 0) {    
        depreciation_text = "यह गाड़ी नई होने के कारण, मूल्यह्रास लागू नहीं होता है&nbsp;&nbsp;";
    } else {
        depreciation_text = "<b>वाहन का मूल्य-ह्रास<\/span></b>&nbsp;&nbsp;<br>खरीदने कि कीमत: "+
            f1.auto_initial_cost + "&#8377;<br>आज का मूल्य: "+
            f1.auto_final_cost + "&#8377;<br>गाड़ी पर आपके अधिकार का काल : "+
            data.age_months + " महीने<br>("+
            f1.auto_initial_cost + "&#8377;-"+
            f1.auto_final_cost + "&#8377;)/"+
            data.age_months + " महीने";
    }
    ...
    {
        case "semestral":
            insurance_text = f1.insurance_value + " रुपये प्रति छमासी";
            break;
        case "anual":
            insurance_text = f1.insurance_value + " रुपये प्रति साल";
            break;
        case "mensal":
            insurance_text = data.monthly_costs.insurance + " रुपये प्रति महीना";
            break;
        case "trimestral":
            insurance_text = f1.insurance_value + " रुपये प्रति त्रैमासिक";
            break;
    }
    
    //Credit interests
    var interests_text="<b>क़र्ज़ का ब्याज<\/b>&nbsp;&nbsp;";
    
    if(f1.cred_auto_s_n == "true") {

        interests_text = "<b>क़र्ज़ का ब्याज</b>&nbsp;&nbsp;<br>वित्त प्रबन्धित रकम: " +
                         f1.credit_amount +
                         "&#8377;<br>ऋण अवधि / ऋण के किस्तों की संख्या: " +
                         f1.credit_period +
                         " महीने<br>मासिक औसत मूल्य: " +
                         f1.credit_value_p_month +
                         "&#8377;<br>अवशेष मूल्य: " +
                         f1.credit_residual_value +
                         "&#8377;<br>";    

        interests_text += "ब्याज कि कुल रकम: "+data.total_interests+"&#8377;<br>(" + data.month_cred + "*"+ f1.credit_value_p_month + ")+" + f1.credit_residual_value + "-" + f1.credit_amount;

        if(data.age_months >= data.month_cred)
            interests_text += "<br>ब्याज कि मासिक रकम: "+data.monthly_costs.credit.toFixed(2)+"&#8377;";
        interests_text += "";
    } 
    ...
    if (f1.nmr_times_inspec !== 0){
        inspection_text = "<b>गाड़ी का मुआइना (MOT test)</b><br>" +
                          f1.nmr_times_inspec +
                          " बार, हर एक बार कि कीमत " +
                          f1.inspec_price +
                          " &#8377; सब के सब, इस कालावधि के दौरन " +
                          data.age_months + " महीने&nbsp;";
    }
    else        
        inspection_text = "<b>गाड़ी का मुआइना (MOT test)</b><br>";
    ...
    //Taxes
    var cartax_text = "<b>उत्पाद शुल्क/ एक्साइस् ड्यूटी (कार कर)</b><br>" +
                      f1.car_tax + " रुपये प्रति साल";
    ...
    switch(f2.type_calc_fuel){
        case "km":                     
            if (f2.take_car_to_job == "false"){
                ...
                {
                    case "1":
                        fuel_text = f2.distance + " km प्रति महीना";
                        break;
                    case "2":                   
                        fuel_text = f2.distance + " हर दो महीनों बाद के किलोमीटर";
                        break;
                    case "3":                   
                        fuel_text = f2.distance + " km प्रति त्रैमासिक";
                        break;
                    case "4":                   
                        fuel_text = f2.distance + " km प्रति छमासी";
                        break;
                    case "5":                   
                        fuel_text = f2.distance + " km प्रति साल";
                        break;
                }
                fuel_text = fuel_text + "<br>" + "आपके वाहन की ईंधन कार्यक्षमता: " + f2.car_consumption + " km/l&nbsp;";
                fuel_text = fuel_text + "<br>" + "ईंधन का औसतन मूल्य : " + f2.fuel_price + " &#8377;/l&nbsp;&nbsp;";
            }
            else{
                fuel_text = f2.days_p_week + " सप्ताह के कितने दिन आप अपनी गाड़ी से कार्यस्थल पर जाते है? <br>";
                fuel_text = fuel_text + "आप चलाते है " + f2.distance_home2job + " किलोमीटर का फ़ासला, आपके घर और कार्यस्थल के बीच <br>";
                fuel_text = fuel_text + "आप चलाते है " + f2.distance_weekend + " जिस दिन आप गाड़ी कार्यस्थल पर नही ले जाते, उस दिन आपकी गाड़ी औसतन इतना दौड़ती है&nbsp;<br>";
                fuel_text = fuel_text + "कुल मिलाकर, औसतन आप इतनी गाड़ी चलाते है " + data.distance_per_month.toFixed(1) + " km प्रति महीना (~30.5 दिन) <br>";
                fuel_text = fuel_text + "आपके वाहन की ईंधन कार्यक्षमता: " + f2.car_consumption + " km/l";
                fuel_text = fuel_text + "<br>" + "आप ईंधन के लिए औसतन कितनी किमत देते है: " + f2.fuel_price + " &#8377;/l";
            }
            break;
        case "euros":
            ...
            {
                case "1":
                    fuel_text = f2.fuel_money + " रुपये प्रति महीना";
                    break;
                case "2":                   
                    fuel_text = f2.fuel_money + " हर दो महीनों बाद के किलोमीटर";
                    break;
                case "3":                   
                    fuel_text = f2.fuel_money + " रुपये प्रति त्रैमासिक";
                    break;
                case "4":                   
                    fuel_text = f2.fuel_money + " रुपये प्रति छमासी";
                    break;
                case "5":                   
                    fuel_text = f2.fuel_money + " रुपये प्रति साल";
                    break;
            }
            break;
    }
    ...
    //Maintenance
    var maintenance_text = "<b>1/2 देखभाल</b><br>" +
                           f2.maintenance + " रुपये प्रति साल";
    
    //Repairs
    var repairs_text = "<b>मरम्मत और सुधार <\/span></b><br>" +
                       f2.repairs + " रुपये प्रति साल";
    
    //Tolls
    var tolls_text="<b>टॉल</b><br>";
    if(f2.type_calc_tolls == "false") {
        switch(data.tolls_period) {
            case "1":
                tolls_text += f2.tolls + " रुपये प्रति महीना";
                break;
            case "2":
                tolls_text += f2.tolls + " रुपये हर दो महीने";
                break;
            case "3":
                tolls_text += f2.tolls + " रुपये प्रति त्रैमासिक";
                break;
            case "4":
                tolls_text += f2.tolls + " रुपये प्रति छमासी";
                break;
            case "5":
                tolls_text += f2.tolls + " रुपये प्रति साल";
                break;
        }
    }
    else 
        tolls_text+=f2.price_tolls_p_day + " रुपये दौरन " + f2.tolls_days_p_month + " महीना";
    tolls_text += "";
    
    //Fines
    var fines_text="<b>ट्रैफिक से संबंधित जुर्माने</b><br>";
    switch(data.fines_period) {
        case "1":           
            fines_text += f2.fines + " रुपये प्रति महीना";
            break;
        case "2":           
            fines_text += f2.fines + " रुपये हर दो महीने";
            break;
        case "3":           
            fines_text += f2.fines+" रुपये प्रति त्रैमासिक";
            break;
        case "4":           
            fines_text += f2.fines + " रुपये प्रति छमासी";
            break;
        case "5":           
            fines_text += f2.fines + " रुपये प्रति साल";
            break;
        }
    fines_text+="";
    
    //washing
    var washing_text="<b>धुलाई और सफाई</b><br>";
    switch(data.washing_period) {
        case "1":
            washing_text += f2.washing + " रुपये प्रति महीना";
            break;
        case "2":
            washing_text += f2.washing + " रुपये हर दो महीने";
            break;
        case "3":
            washing_text += f2.washing +" रुपये प्रति त्रैमासिक";
            break;
        case "4":
            washing_text += f2.washing + " रुपये प्रति छमासी";
            break;
        case "5":
            washing_text += f2.washing + " रुपये प्रति साल";
            break;
        }
    washing_text+="";
    ...
    varResult+= "<tr><td style=\"padding:10px 50px;\" colspan=\"2\"><b>स्थिर खर्च</b><br>" +
                "<i>ऐसे खर्च, जो गाड़ी की पूरी कि हुई दूरी पर निर्भर नहीं होती हैं और अगर कार इस्तेमाल में ना हो, तब भी भुगतान करने होते है</i></td></tr>";
    
    //Costs || Monthly amount
    varResult+= "<tr><td style=\"padding:10px 15px 10px 15px;\"><b>खर्च</b></td>" +
                "<td><b>मासिक रकम</b></td></tr>";
    
    //standing costs items
    varResult+= "<tr><td>" + depreciation_text + "&nbsp;</td>" + 
                "<td>&nbsp;" + currencyShow(data.monthly_costs.depreciation.toFixed(1)) + "</td></tr>";
    
    varResult+= "<tr><td><b>गाड़ी का बीमा और व्यवधान रक्षा</b><br>" + insurance_text + "</td>" +
    ...
    varResult+= "<tr><td style=\"padding:4px 10px 4px 0;\"><b>कुल - स्थिर खर्च</b></td>"+
                "<td>&nbsp;<b>" + currencyShow(data.total_standing_costs_month.toFixed(0)) + "/महीना</b></td></tr>";
    ...
    varResult+= "<tr><td style=\"padding:10px 15px;\" colspan=\"2\"><b>चालू लागत</b><br>" +
                "<i>आपके द्वारा चलाये जानेवाले किलोमीटर की संख्या पर निर्भर खर्च</i></td></tr>";
                  
    //Costs || Monthly amount
    varResult+= "<tr><td style=\"padding:10px 15px 10px 15px;\"><b>खर्च</b></td>" +
                "<td><b>मासिक रकम</b></td></tr>";

    varResult+= "<tr><td><b>ईंधन</b><br>" + fuel_text + "</td>" +
    ...
    varResult+= "<tr><td><b>पार्किंग</b></td>"+
    ...
    //TOTAL - Running costs
    varResult+= "<tr><td style=\"padding:4px 10px 4px 0;\"><b>कुल - चालू लागत</b></td>"+
                "<td>&nbsp;<b>" + currencyShow(data.total_running_costs_month.toFixed(0)) + "/महीना</b></td></tr>";
    ...
    varResult+= "<tr><td style=\"padding:10px 15px;\" colspan=\"2\"><b>कुल </b><br></td></tr>"; 

    if((typeof data.distance_per_month) !== 'undefined' && data.distance_per_month !== 0){
              
        varResult+= "<tr><td><b>चालू लागत प्रति किलोमीटर</b></td>"+
                    "<td>&nbsp;" + currencyShow(data.running_costs_p_unit_distance.toFixed(2)) + "/km </td></tr>";
        
        varResult+= "<tr><td class=\"border_bottom_2px\"><b>कुल लागत प्रति किलोमीटर</b></td>" +
                    "<td class=\"border_bottom_2px\">&nbsp;" + currencyShow(data.total_costs_p_unit_distance.toFixed(2)) + "/km </td></tr>";
    }

    varResult+= "<tr><td><b>स्थिर खर्च</b></td>"+
                "<td>&nbsp;<b>" + currencyShow(data.total_standing_costs_month.toFixed(0)) + "/महीना</b></td></tr>";
    
    varResult+= "<tr><td><b>चालू लागत</b></td>"+
                "<td>&nbsp;<b>" + currencyShow(data.total_running_costs_month.toFixed(0)) + "/महीना</b></td></tr>";    
    
    varResult+="<tr><td style=\"padding:6px 10px 6px 0;\"><b>कुल </b></td>"+
               "<td>&nbsp;<b>" + currencyShow(data.total_costs_month.toFixed(0)) + "/महीना</b></td></tr>";
...
function print_feffort_table(f1, f2, f3, data){
    ...
    varResult+="<tr><td colspan=\"2\"><b>वित्तीय प्रयास</b></td></tr>";
    //income
    varResult+="<tr><td colspan=\"2\"><b>आमदनी</b></tr>";
    switch(f3.income_type){
        case 'year':    
            varResult+= "<tr><td>शुद्ध आय प्रति  साल</td>" + 
                        "<td style=\"width:20%\">" + currencyShow(data.fin_effort.income) + "</td></tr>" +
                        "<tr><td>औसत शुद्ध आय प्रति  महीना</td>" + 
                        "<td>" + currencyShow(data.fin_effort.aver_income_per_month.toFixed(1)) + "</td></tr>";
            break;
        case 'month':
            varResult+= "<tr><td>शुद्ध आय प्रति  महीना</td>" + 
                        "<td style=\"width:20%\">" + currencyShow(data.fin_effort.income) + "</td></tr>" +
                        "<tr><td>प्रति वर्ष, कितने महीने फलदार/ आय होती है</td>" + 
                        "<td>" + data.fin_effort.income_per_type + "</td></tr>" +
                        "<tr><td>औसत शुद्ध आय प्रति  महीना</td>" + 
                        "<td>" + currencyShow(data.fin_effort.aver_income_per_month.toFixed(1)) + "</td></tr>" +
                        "<tr><td>औसत शुद्ध आय प्रति  साल</td>" + 
                        "<td>" + currencyShow(data.fin_effort.income_per_year.toFixed(1)) + "</td></tr>";
            break;
        case 'week':
            varResult+= "<tr><td>शुद्ध आय प्रति  हफ़्ता</td>" + 
                        "<td style=\"width:20%\">" + currencyShow(data.fin_effort.income) + "</td></tr>"+
                        "<tr><td>प्रति वर्ष, कितने हफ्ते उपजाऊ/ आय प्रप्ति होते है</td>" + 
                        "<td>" + data.fin_effort.income_per_type + "</td></tr>" +
                        "<tr><td>औसत शुद्ध आय प्रति  महीना</td>" + 
                        "<td>" + currencyShow(data.fin_effort.aver_income_per_month.toFixed(1)) + "</td></tr>"+
                        "<tr><td>औसत शुद्ध आय प्रति  साल</td>" + 
            ...
            break;  
        case 'hour':
            varResult+= "<tr><td>शुद्ध आय प्रति  घंटा</td>" + 
                        "<td style=\"width:20%\">" + currencyShow(data.fin_effort.income) + "</td></tr>"+
                        "<tr><td>हर हफ्ते, कितने घंटों के काम का मूल्य मिलता है</td>" + 
    ...
    if(f3.income_type != 'hour'){
        varResult+=     "<tr><td colspan=\"2\"><b>काम का समय</b></tr>";
        if(f3.is_working_time == 'true'){
            varResult+= "<tr><td>घंटे प्रति हफ़्ता</td>" +
                        "<td>"+data.fin_effort.time_hours_per_week+" h</td></tr>" +
                        "<tr><td>महीने प्रति साल</td>" + 
                        "<td>"+data.fin_effort.time_month_per_year+"</td></tr>" +
                        "<tr><td>औसत कामकाज के घंटे प्रति महीना</td>" + 
                        "<td>"+data.fin_effort.aver_work_time_per_m.toFixed(1)+" h</td></tr>" +
                        "<tr><td>कार्य समय प्रति साल</td>" + 
                        "<td>"+data.fin_effort.work_hours_per_y.toFixed(1)+" h</td></tr>";
        }
        else{
            varResult+= "<tr><td colspan=\"2\">गणना के लिए, प्रति सप्ताह औसतन 36 घंटे और प्रति वर्ष 11 महीने काम करने का समय माना जाता था</td></tr>";
        }
    }           
    varResult+= "<tr><td>औसत शुद्ध आय प्रति  घंटा</td>" +
                "<td>&nbsp;" + currencyShow(data.fin_effort.aver_income_per_hour.toFixed(1)) + "</td></tr>";
    
    //distance
    varResult+= "<tr><td colspan=\"2\"><b>फ़ासला</b></td></tr>";
    if((f2.type_calc_fuel != 'km' && f3.drive_to_work == 'true') || (f2.type_calc_fuel != 'km' && f2.take_car_to_job == 'true')){   
        varResult+=  "<tr><td>आप घर से कार्यस्थल जाने के लिए ड्राइव करते हैं</td>"  +  
                     "<td>" + parseInt(f3.dist_home_job).toFixed(1) + " km</td></tr>"+
                     "<tr><td>सप्ताह के कुल दिन जब आप काम पर अपनी गाड़ी से जाते है</td>"  +  
                     "<td>" + f3.drive_to_work_days_per_week + " दिन</td></tr>" +
                     "<tr><td>जब आप गाड़ी को कार्यस्थल पर नहीं ले जाते हैं, तब आप इतना ड्राइव करते हैं</td>" + 
                     "<td>" + parseInt(f3.journey_weekend).toFixed(1) + " km</td></tr>"+
                     "<tr><td>औसतन, आप प्रति सप्ताह इतना ड्राइव करते हैं</td>" + 
                     "<td>" + data.driving_distance.aver_drive_per_week.toFixed(1) + " km</td></tr>";                  
    }

    varResult+=  "<tr><td>आप गाड़ी चलाते है, प्रति महीना</td>" +
                 "<td>" + data.distance_per_month.toFixed(1) + " km</td></tr>" +
                 "<tr><td>आप गाड़ी चलाते है, प्रति साल</td>" + 
                 "<td>" + data.driving_distance.drive_per_year.toFixed(1) + " km</td></tr>";  

    //time spent in driving
    varResult+=  "<tr><td colspan=\"2\"><b>ड्राइविंग में बिताया समय </b></td></tr>";

    if(f3.drive_to_work == 'true' || f2.take_car_to_job == 'true'){
        varResult+= "<tr><td>मिनट, आप घर से कार्यस्थल पहुँचने में लगाते हैं</td>" + 
                    "<td>" + f3.time_home_job + " मिनट</td></tr>" +
                    "<tr><td>सप्ताह के कुल दिन जब आप काम पर गाड़ी से जाते है</td>" + 
                    "<td>" + f3.drive_to_work_days_per_week + " दिन</td></tr>" +
                    "<tr><td>जिस दिन आप कार को कार्यस्थल पर नहीं ले जाते हैं, उस दिन आप इतना समय ड्राइव करते हैं </td>" + 
                    "<td>" + f3.time_weekend + " मिनट</td></tr>" +
                    "<tr><td>इतने मिनट आप ड्राइव करते हैं, प्रति हफ़्ता</td>" + 
                    "<td>" + data.time_spent_driving.min_drive_per_week + " मिनट</td></tr>";
    }
    else{
        varResult+= "<tr><td>इतने मिनट आप ड्राइव करते हैं, प्रति दिन</td>" + 
                    "<td>" + f3.min_drive_per_day + " मिनट</td></tr>" +
                    "<tr><td>महीने के कुल दिन जब आप ड्राइव करते है</td>" + 
                    "<td>" + f3.days_drive_per_month + " दिन</td></tr>";
    }

    varResult+= "<tr><td>इतने घंटे आप ड्राइव करते है, प्रति महीना</td>" + 
                "<td>" + data.time_spent_driving.hours_drive_per_month.toFixed(1) + " h</td></tr>"+
                "<tr><td>इतने घंटे आप ड्राइव करते है, प्रति साल</td>" + 
                "<td>" + data.time_spent_driving.hours_drive_per_year.toFixed(1) + " h</td></tr>";

    //financial effort
    varResult+= "<tr><td colspan=\"2\"><b>वित्तीय प्रयास" +
                ': ' + (data.total_costs_year/data.fin_effort.income_per_year*100).toFixed(0) + 
                '&#37;</b>' +
                "<tr><td>गाड़ी के लिए प्रति वर्ष कि कुल लागत</td>" + 
                "<td>" + currencyShow(data.fin_effort.total_costs_year.toFixed(1)) + "</td></tr>" +
                "<tr><td>अपनी ख़ुद कि गाड़ी बनाये रखने के लिए, प्रति वर्ष आपको इतने घंटे काम करने की आवश्यकता है </td>"  +  
                "<td>" + data.fin_effort.hours_per_year_to_afford_car.toFixed(1) + " h</td></tr>"+
                "<tr><td>अपनी ख़ुद कि गाड़ी बनाये रखने के लिए, प्रति वर्ष आपको इतने महीने काम करने की आवश्यकता है</td>" +  
                "<td>" + data.fin_effort.month_per_year_to_afford_car.toFixed(2)+"</td></tr>"+
                "<tr><td>1 जनवरी के बाद, कितने दिनों के लिए कार का भुगतान किया जाता है</td>" +  
                "<td>" + Math.ceil(data.fin_effort.days_car_paid) + " दिन</td></tr>";
           

    //speed
    varResult+= "<tr><td>वार्षिक औसत गाड़ी चलाने कि गति</td>"+
                "<td>" + data.kinetic_speed.toFixed(1) + " km/h</td></tr>";
                        
    varResult+= "<tr><td>वार्षिक औसत <a href=\"./docs/consumer_speed.html\" target=\"_blank\">उपभोक्ता कि गति</a></td>"+
...
function print_AlternativeToCarCosts_table(f1, f2, f3, data, country){
    ...
    if(data.public_transports.display_pt()) {
        ...
        tp_text = "<b>अपने परिवार के दैनिक जीवन के लिए सार्वजनिक परिवहन</b><br>आपके परिवार में 4 साल से अधिक आयु वाले लोगों कि संख्या: " + 
                  f3.n_pess_familia + " व्यक्ति" +
                  "<br>मासिक सीजन टिकट की प्रति व्यक्ति के लिए औसत राशि: " + 
                  f3.monthly_pass_cost + "&#8377;";
        
        if(data.public_transports.pt_carcost_ratio < data.public_transports.other_pt_ratio_threshold){
            outros_tp_text="<b>अन्य सार्वजनिक परिवहन</b><br>राशि जो अभी भी अन्य सार्वजनिक परिवहन के लिए छोड़ी गई थी, उदाहरण के लिए आपके आवासीय क्षेत्र से बाहर, जैसे कि लंबी यात्रा कि गाडिया या बसो ";
        }
        taxi_text="<b>टैक्सी परिवहन <\/span><\/b><br>" + data.public_transports.km_by_taxi.toFixed(1) + " km टैक्सी से, किराया " + data.public_transports.taxi_price_per_km.toFixed(1) + "&#8377;/km";
        
        //starts HTML table
        varResult+="<table class=\"result_table\" id=\"result_table2\">";
        //header
        varResult+="<tr><td><b>खर्च</b><br></td>"+
                   "<td><b>मासिक रकम</b></td></tr>";
        //items
        ...
        varResult+="<tr><td style=\"padding:6px 10px 6px 0;\"><b>कुल </b></td>"+
                   "<td><b>" + currencyShow(data.public_transports.total_altern.toFixed(0)) + "/महीना</b></td></tr>";
    ...
    if(UBER_SWITCH){
        ...
        if (res_uber_obj){
            ...
            if(res_uber_obj.result_type==1){
                ...
                varResult+="<tr><td><b>UBER - खर्च प्रति kilometres</b>" + uber_url_HTML + "</td>" + 
                           "<td>" + currencyShow(res_uber_obj.ucd.toFixed(2)) + "/" + "km</td></tr>";
                
                varResult+="<tr><td><b>UBER - खर्च प्रति मिनट</b>" + uber_url_HTML + "</td>" + 
                           "<td>" + currencyShow(res_uber_obj.ucm.toFixed(2)) + "/" + "मिनट</td></tr>";

                varResult+="<tr><td><b>आप इतने किलोमीटर चलाते है प्रति महीना</b><br></td>"+
                           "<td>" + res_uber_obj.dpm.toFixed(0) + " " +"kilometres</td></tr>";
                
                           
                varResult+="<tr><td><b>इतने मिनट आप ड्राइव करते हैं, प्रति महीना</b></td>" + 
                           "<td>" + res_uber_obj.mdpm.toFixed(0) + " " + "मिनट</td></tr>";
                           
                varResult+="<tr><td><b>UBER: खर्च - कुल </b></td>" + 
                           "<td><b>" + currencyShow(res_uber_obj.tuc.toFixed(0)) + "</b></td></tr>";                     

                varResult+="<tr><td><b>अन्य सार्वजनिक परिवहन</b><br>राशि जो अभी भी अन्य सार्वजनिक परिवहन के लिए छोड़ी गई थी, उदाहरण के लिए आपके आवासीय क्षेत्र से बाहर, जैसे कि लंबी यात्रा कि गाडिया या बसो</td>" + 
                           "<td><b>" + currencyShow(res_uber_obj.delta.toFixed(0)) + "</b></td></tr>";
                
                varResult+="<tr><td><b>कुल </b></td>"+
                           "<td><b>" + currencyShow(data.total_costs_month.toFixed(0)) + "/महीना</b></td></tr>";
            ...
            //the case where uber equivalent is more expensive
                ...
                varResult+="<tr><td><b>अपने परिवार के दैनिक जीवन के लिए सार्वजनिक परिवहन</b><br>आपके परिवार में 4 साल से अधिक आयु वाले लोगों कि संख्या: " + f3.n_pess_familia + " व्यक्ति" +
                           "<br>मासिक सीजन टिकट की प्रति व्यक्ति के लिए औसत राशि: " + f3.monthly_pass_cost + "&#8377;</td>" +
                ...
                varResult+="<tr><td><b>काइनेटिक गति</b></td>" + 
                           "<td>" + data.kinetic_speed.toFixed(2) + " " +"km/h</td></tr>";
                           
                varResult+="<tr><td><b>UBER - kilometres प्रति महीना</b></td>" + 
...
function print_extern_table(f1, f2, f3, data){ 
    ...
    if(Country=="PT" && isDef(data.distance_per_month)){
        ...
        //header
        varResult+="<tr><td><b>Custos externos</b><br>Percorre " +(1 * data.distance_per_month).toFixed(1)+" km/महीना</td>" +
                   "<td><b>मासिक रकम</b></td></tr>";
        ...
        varResult+="<tr><td>" + ifr_estr_text + "</td>" + 
         ...
         //total
        varResult+="<tr><td style=\"padding:6px 10px 6px 0;\"><b>कुल </b></td>" +
                   "<td><b>&#8377;&nbsp;"+data.external_costs.total_exter().toFixed(0)+"/महीना</b></td></tr>";
