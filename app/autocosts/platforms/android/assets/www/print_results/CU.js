...
function Run2(callback){
    ...
    if(SOCIAL_SWITCH){
        $("#shareIcons").jsSocials({
            url: 'http://autocostos.info/CU',
            text: 'Esta calculadora te permitirá conocer el verdadero costo de ser propietario de un vehículo en Cuba',
            showLabel: false,
            showCount: false,
...
function print_result_final_text(data){
    ...
    if(data.total_costs_month >= 150 && data.age_months > 6) {
        ...
        var text_msg = '<div>Con este nivel de gastos, tu vehículo durante '+
                       ...
                       ' ' + 'PESOS CUBANOS CONVERTIBLES</div></div>';
        return text_msg;
    }
    else{
        return "";
...
function print_costs_table(f1, f2, f3, data) {
    ...
    {
        case "semestral":
            insurance_text = f1.insurance_value + " Pesos Cubanos Convertibles por semestre";
            break;
        case "anual":
            insurance_text = f1.insurance_value + " Pesos Cubanos Convertibles por año";
            break;
        case "mensal":
            insurance_text = data.monthly_costs.insurance + " Pesos Cubanos Convertibles por mes";
            break;
        case "trimestral":
            insurance_text = f1.insurance_value + " Pesos Cubanos Convertibles por trimestre";
            break;
    }
    ...
    if (f1.nmr_times_inspec !== 0){
        inspection_text = "<b>Revisión Técnica Automotor (RTA)</b><br>" +
                          f1.nmr_times_inspec +
                          " veces, costando " +
                          f1.inspec_price +
                          " &#36; cada una durante " +
    ...
    var cartax_text = "<b>Impuestos del vehículo</b><br>" +
                      f1.car_tax + " Pesos Cubanos Convertibles por año";
    ...
    switch(f2.type_calc_fuel){
        case "km":                     
            if (f2.take_car_to_job == "false"){
                ...
                fuel_text = fuel_text + "<br>" + "Gasto promedio en combustible: " + f2.fuel_price + " &#36;/l";
            }
            break;
        case "euros":
            ...
            {
                case "1":
                    fuel_text = f2.fuel_money + " Pesos Cubanos Convertibles por mes";
                    break;
                case "2":                   
                    fuel_text = f2.fuel_money + " kilómetros por bimestre";
                    break;
                case "3":                   
                    fuel_text = f2.fuel_money + " Pesos Cubanos Convertibles por trimestre";
                    break;
                case "4":                   
                    fuel_text = f2.fuel_money + " Pesos Cubanos Convertibles por semestre";
                    break;
                case "5":                   
                    fuel_text = f2.fuel_money + " Pesos Cubanos Convertibles por año";
                    break;
            }
            break;
    }
    ...
    var maintenance_text = "<b>1/2 Mantenimiento</b><br>" +
                           f2.maintenance + " Pesos Cubanos Convertibles por año";
    
    //Repairs
    var repairs_text = "<b>Reparaciones y mejoras<\/span></b><br>" +
                       f2.repairs + " Pesos Cubanos Convertibles por año";
    ...
    if(f2.type_calc_tolls == "false") {
        switch(data.tolls_period) {
            case "1":
                tolls_text += f2.tolls + " Pesos Cubanos Convertibles por mes";
                break;
            case "2":
                tolls_text += f2.tolls + " Pesos Cubanos Convertibles por cada bimestre";
                break;
            case "3":
                tolls_text += f2.tolls + " Pesos Cubanos Convertibles por trimestre";
                break;
            case "4":
                tolls_text += f2.tolls + " Pesos Cubanos Convertibles por semestre";
                break;
            case "5":
                tolls_text += f2.tolls + " Pesos Cubanos Convertibles por año";
                break;
        }
    }
    else 
        tolls_text+=f2.price_tolls_p_day + " Pesos Cubanos Convertibles durante " + f2.tolls_days_p_month + " mes";
    tolls_text += "";
    ...
    switch(data.fines_period) {
        case "1":           
            fines_text += f2.fines + " Pesos Cubanos Convertibles por mes";
            break;
        case "2":           
            fines_text += f2.fines + " Pesos Cubanos Convertibles por cada bimestre";
            break;
        case "3":           
            fines_text += f2.fines+" Pesos Cubanos Convertibles por trimestre";
            break;
        case "4":           
            fines_text += f2.fines + " Pesos Cubanos Convertibles por semestre";
            break;
        case "5":           
            fines_text += f2.fines + " Pesos Cubanos Convertibles por año";
            break;
        }
    fines_text+="";
    ...
    switch(data.washing_period) {
        case "1":
            washing_text += f2.washing + " Pesos Cubanos Convertibles por mes";
            break;
        case "2":
            washing_text += f2.washing + " Pesos Cubanos Convertibles por cada bimestre";
            break;
        case "3":
            washing_text += f2.washing +" Pesos Cubanos Convertibles por trimestre";
            break;
        case "4":
            washing_text += f2.washing + " Pesos Cubanos Convertibles por semestre";
            break;
        case "5":
            washing_text += f2.washing + " Pesos Cubanos Convertibles por año";
            break;
        }
    washing_text+="";
