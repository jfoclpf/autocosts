...
function Run2(callback){
    ...
    if(SOCIAL_SWITCH){
        $("#shareIcons").jsSocials({
            url: 'http://autocostos.info/EC',
            text: 'Esta calculadora te permitirá conocer el verdadero costo de ser propietario de un vehículo en Ecuador',
            showLabel: false,
            showCount: false,
...
function print_costs_table(f1, f2, f3, data) {
    ...
    varResult+= "<tr><td><b>Seguro de vehículo y SPPAT</b><br>" + insurance_text + "</td>" +
