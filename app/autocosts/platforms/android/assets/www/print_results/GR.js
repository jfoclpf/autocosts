...
function Run2(callback){
    ...
    if(SOCIAL_SWITCH){
        $("#shareIcons").jsSocials({
            url: 'http://autocosts.info/GR',
            text: 'Αυτή η εφαρμογή θα σας επιτρέψει να υπολογίσετε τα πραγματικά έξοδα ενός αυτοκινήτου στην Ελλάδα',
            showLabel: false,
            showCount: false,
...
function print_result_final_text(data){
    ...
    if(data.total_costs_month >= 150 && data.age_months > 6) {
        ...
        var text_msg = '<div>Με αυτά τα έξοδα, για τους '+
                       '<b>' + data.age_months + '</b> μήνες που έχετε στην κατοχή σας το όχημα, σας έχει στοιχίσει ήδη:</div>'+
...
function print_costs_table(f1, f2, f3, data) {
    ...
    if (data.age_months === 0) {    
        depreciation_text = "Η υποτίμηση δεν ισχύει γιατί το όχημα είναι καινούργιο&nbsp;&nbsp;";
    } else {
        depreciation_text = "<b>Υποτίμηση της αξίας του οχήματος<\/span></b>&nbsp;&nbsp;<br>Αξία κτήσης: "+
            f1.auto_initial_cost + "&euro;<br>Τελική αξία: "+
            f1.auto_final_cost + "&euro;<br>Διάστημα κατοχής του οχήματος: "+
            data.age_months + " μήνες<br>("+
            f1.auto_initial_cost + "&euro;-"+
            f1.auto_final_cost + "&euro;)/"+
            data.age_months + " μήνες";
    }
    ...
    {
        case "semestral":
            insurance_text = f1.insurance_value + " Ευρώ ανά εξάμηνο";
            break;
        case "anual":
            insurance_text = f1.insurance_value + " Ευρώ ανά έτος";
            break;
        case "mensal":
            insurance_text = data.monthly_costs.insurance + " Ευρώ ανά μήνα";
            break;
        case "trimestral":
            insurance_text = f1.insurance_value + " Ευρώ ανά τρίμηνο";
            break;
    }
    
    //Credit interests
    var interests_text="<b>Επιτόκιο δανείου<\/b>&nbsp;&nbsp;";
    
    if(f1.cred_auto_s_n == "true") {

        interests_text = "<b>Επιτόκιο δανείου</b>&nbsp;&nbsp;<br>Ποσό δανείου: " +
                         f1.credit_amount +
                         "&euro;<br>Περίοδος δανείου / αριθμός δόσεων: " +
                         f1.credit_period +
                         " μήνες<br>Μέση μηνιαία αξία: " +
                         f1.credit_value_p_month +
                         "&euro;<br>Καθαρή απομένουσα αξία: " +
                         f1.credit_residual_value +
                         "&euro;<br>";    

        interests_text += "Συνολικό ποσό επιτοκίου: "+data.total_interests+"&euro;<br>(" + data.month_cred + "*"+ f1.credit_value_p_month + ")+" + f1.credit_residual_value + "-" + f1.credit_amount;

        if(data.age_months >= data.month_cred)
            interests_text += "<br>Μηνιαίο επιτόκιο: "+data.monthly_costs.credit.toFixed(2)+"&euro;";
        interests_text += "";
    } 
    ...
    //Taxes
    var cartax_text = "<b>Τέλη κυκλοφορίας (αν ισχύουν)</b><br>" +
                      f1.car_tax + " Ευρώ ανά έτος";
    ...
    switch(f2.type_calc_fuel){
        case "km":                     
            if (f2.take_car_to_job == "false"){
                ...
                {
                    case "1":
                        fuel_text = f2.distance + " χλμ ανά μήνα";
                        break;
                    case "2":                   
                        fuel_text = f2.distance + " χιλιόμετρα ανά δύο μήνες";
                        break;
                    case "3":                   
                        fuel_text = f2.distance + " χλμ ανά τρίμηνο";
                        break;
                    case "4":                   
                        fuel_text = f2.distance + " χλμ ανά εξάμηνο";
                        break;
                    case "5":                   
                        fuel_text = f2.distance + " χλμ ανά έτος";
                        break;
                }
                fuel_text = fuel_text + "<br>" + "Αποδοτικότητα καυσίμων του οχήματός σας: " + f2.car_consumption + " χλμ/λίτρο&nbsp;";
                fuel_text = fuel_text + "<br>" + "Μέση τιμή βενζίνης: " + f2.fuel_price + " &euro;/λίτρο&nbsp;&nbsp;";
            }
            else{
                fuel_text = f2.days_p_week + " Ημέρα/ημέρες την εβδομάδα που πηγαίνετε στη δουλειά με το αυτοκίνητο <br>";
                fuel_text = fuel_text + "Διανύετε " + f2.distance_home2job + " χιλιόμετρα που διανύετε από το σπίτι ως τη δουλειά <br>";
                fuel_text = fuel_text + "Διανύετε " + f2.distance_weekend + " μέσος όρος χιλιομέτρων που διανύετε τις ημέρες που δεν πάτε στη δουλειά με το αυτοκίνητό σας&nbsp;<br>";
                fuel_text = fuel_text + "Μέση κατανάλωση καυσίμων " + data.distance_per_month.toFixed(1) + " χλμ ανά μήνα (~30.5 ημέρες) <br>";
                fuel_text = fuel_text + "Αποδοτικότητα καυσίμων του οχήματός σας: " + f2.car_consumption + " χλμ/λίτρο";
                fuel_text = fuel_text + "<br>" + "Μέσος όρος χρημάτων που πληρώνετε για καύσιμα/βενζίνη: " + f2.fuel_price + " &euro;/λίτρο";
            }
            break;
        case "euros":
            ...
            {
                case "1":
                    fuel_text = f2.fuel_money + " Ευρώ ανά μήνα";
                    break;
                case "2":                   
                    fuel_text = f2.fuel_money + " χιλιόμετρα ανά δύο μήνες";
                    break;
                case "3":                   
                    fuel_text = f2.fuel_money + " Ευρώ ανά τρίμηνο";
                    break;
                case "4":                   
                    fuel_text = f2.fuel_money + " Ευρώ ανά εξάμηνο";
                    break;
                case "5":                   
                    fuel_text = f2.fuel_money + " Ευρώ ανά έτος";
                    break;
            }
            break;
    }
    ...
    //Maintenance
    var maintenance_text = "<b>1/2 Συντήρηση</b><br>" +
                           f2.maintenance + " Ευρώ ανά έτος";
    
    //Repairs
    var repairs_text = "<b>Επισκευές και βελτιώσεις<\/span></b><br>" +
                       f2.repairs + " Ευρώ ανά έτος";
    
    //Tolls
    var tolls_text="<b>Διόδια</b><br>";
    if(f2.type_calc_tolls == "false") {
        switch(data.tolls_period) {
            case "1":
                tolls_text += f2.tolls + " Ευρώ ανά μήνα";
                break;
            case "2":
                tolls_text += f2.tolls + " Ευρώ κάθε δύο μήνες";
                break;
            case "3":
                tolls_text += f2.tolls + " Ευρώ ανά τρίμηνο";
                break;
            case "4":
                tolls_text += f2.tolls + " Ευρώ ανά εξάμηνο";
                break;
            case "5":
                tolls_text += f2.tolls + " Ευρώ ανά έτος";
                break;
        }
    }
    else 
        tolls_text+=f2.price_tolls_p_day + " Ευρώ για " + f2.tolls_days_p_month + " μήνα";
    tolls_text += "";
    
    //Fines
    var fines_text="<b>Κλήσεις Τροχαίας</b><br>";
    switch(data.fines_period) {
        case "1":           
            fines_text += f2.fines + " Ευρώ ανά μήνα";
            break;
        case "2":           
            fines_text += f2.fines + " Ευρώ κάθε δύο μήνες";
            break;
        case "3":           
            fines_text += f2.fines+" Ευρώ ανά τρίμηνο";
            break;
        case "4":           
            fines_text += f2.fines + " Ευρώ ανά εξάμηνο";
            break;
        case "5":           
            fines_text += f2.fines + " Ευρώ ανά έτος";
            break;
        }
    fines_text+="";
    
    //washing
    var washing_text="<b>Πλύσιμο και καθαρισμός</b><br>";
    switch(data.washing_period) {
        case "1":
            washing_text += f2.washing + " Ευρώ ανά μήνα";
            break;
        case "2":
            washing_text += f2.washing + " Ευρώ κάθε δύο μήνες";
            break;
        case "3":
            washing_text += f2.washing +" Ευρώ ανά τρίμηνο";
            break;
        case "4":
            washing_text += f2.washing + " Ευρώ ανά εξάμηνο";
            break;
        case "5":
            washing_text += f2.washing + " Ευρώ ανά έτος";
            break;
        }
    washing_text+="";
    ...
    varResult+= "<tr><td style=\"padding:10px 50px;\" colspan=\"2\"><b>Πάγια έξοδα</b><br>" +
                "<i>Έξοδα που δεν εξαρτώνται από την απόσταση του διανύετε και τέλη που καταβάλλονται ακόμη και αν το αυτοκίνητο δεν χρησιμοποιείται</i></td></tr>";
    
    //Costs || Monthly amount
    varResult+= "<tr><td style=\"padding:10px 15px 10px 15px;\"><b>Κόστος</b></td>" +
                "<td><b>Μηνιαίο ποσό</b></td></tr>";
    
    //standing costs items
    varResult+= "<tr><td>" + depreciation_text + "&nbsp;</td>" + 
                "<td>&nbsp;" + currencyShow(data.monthly_costs.depreciation.toFixed(1)) + "</td></tr>";
    
    varResult+= "<tr><td><b>Ασφάλεια οχήματος και κάλυψη σε περίπτωση βλάβης</b><br>" + insurance_text + "</td>" +
    ...
    varResult+= "<tr><td style=\"padding:4px 10px 4px 0;\"><b>ΣΥΝΟΛΟ - Πάγια τέλη</b></td>"+
                "<td>&nbsp;<b>" + currencyShow(data.total_standing_costs_month.toFixed(0)) + "/μήνα</b></td></tr>";
    ...
    varResult+= "<tr><td style=\"padding:10px 15px;\" colspan=\"2\"><b>Λειτουργικά έξοδα</b><br>" +
                "<i>Έξοδα που εξαρτώνται από τα χιλιόμετρα που διανύετε</i></td></tr>";
                  
    //Costs || Monthly amount
    varResult+= "<tr><td style=\"padding:10px 15px 10px 15px;\"><b>Κόστος</b></td>" +
                "<td><b>Μηνιαίο ποσό</b></td></tr>";

    varResult+= "<tr><td><b>Καύσιμα</b><br>" + fuel_text + "</td>" +
    ...
    varResult+= "<tr><td><b>Στάθμευση</b></td>"+
    ...
    //TOTAL - Running costs
    varResult+= "<tr><td style=\"padding:4px 10px 4px 0;\"><b>ΣΥΝΟΛΟ - Λειτουργικά έξοδα</b></td>"+
                "<td>&nbsp;<b>" + currencyShow(data.total_running_costs_month.toFixed(0)) + "/μήνα</b></td></tr>";
    ...
    varResult+= "<tr><td style=\"padding:10px 15px;\" colspan=\"2\"><b>ΣΥΝΟΛΟ</b><br></td></tr>"; 

    if((typeof data.distance_per_month) !== 'undefined' && data.distance_per_month !== 0){
              
        varResult+= "<tr><td><b>Λειτουργικά έξοδα ανά χιλιόμετρο</b></td>"+
                    "<td>&nbsp;" + currencyShow(data.running_costs_p_unit_distance.toFixed(2)) + "/χλμ </td></tr>";
        
        varResult+= "<tr><td class=\"border_bottom_2px\"><b>Συνολικά έξοδα ανά χιλιόμετρο</b></td>" +
                    "<td class=\"border_bottom_2px\">&nbsp;" + currencyShow(data.total_costs_p_unit_distance.toFixed(2)) + "/χλμ </td></tr>";
    }

    varResult+= "<tr><td><b>Πάγια έξοδα</b></td>"+
                "<td>&nbsp;<b>" + currencyShow(data.total_standing_costs_month.toFixed(0)) + "/μήνα</b></td></tr>";
    
    varResult+= "<tr><td><b>Λειτουργικά έξοδα</b></td>"+
                "<td>&nbsp;<b>" + currencyShow(data.total_running_costs_month.toFixed(0)) + "/μήνα</b></td></tr>";    
    
    varResult+="<tr><td style=\"padding:6px 10px 6px 0;\"><b>ΣΥΝΟΛΟ</b></td>"+
               "<td>&nbsp;<b>" + currencyShow(data.total_costs_month.toFixed(0)) + "/μήνα</b></td></tr>";
...
function print_feffort_table(f1, f2, f3, data){
    ...
    varResult+="<tr><td colspan=\"2\"><b>Χρηματοδότηση</b></td></tr>";
    //income
    varResult+="<tr><td colspan=\"2\"><b>Εισόδημα</b></tr>";
    switch(f3.income_type){
        case 'year':    
            varResult+= "<tr><td>Καθαρό εισόδημα ανά έτος</td>" + 
                        "<td style=\"width:20%\">" + currencyShow(data.fin_effort.income) + "</td></tr>" +
                        "<tr><td>Μέσος όρος καθαρού εισοδήματος ανά μήνα</td>" + 
                        "<td>" + currencyShow(data.fin_effort.aver_income_per_month.toFixed(1)) + "</td></tr>";
            break;
        case 'month':
            varResult+= "<tr><td>Καθαρό εισόδημα ανά μήνα</td>" + 
                        "<td style=\"width:20%\">" + currencyShow(data.fin_effort.income) + "</td></tr>" +
                        "<tr><td>Αριθμός μηνών ανά έτος εισοδήματος</td>" + 
                        "<td>" + data.fin_effort.income_per_type + "</td></tr>" +
                        "<tr><td>Μέσος όρος καθαρού εισοδήματος ανά μήνα</td>" + 
                        "<td>" + currencyShow(data.fin_effort.aver_income_per_month.toFixed(1)) + "</td></tr>" +
                        "<tr><td>Μέσος όρος καθαρού εισοδήματος ανά έτος</td>" + 
                        "<td>" + currencyShow(data.fin_effort.income_per_year.toFixed(1)) + "</td></tr>";
            break;
        case 'week':
            varResult+= "<tr><td>Καθαρό εισόδημα ανά εβδομάδα</td>" + 
                        "<td style=\"width:20%\">" + currencyShow(data.fin_effort.income) + "</td></tr>"+
                        "<tr><td>Αριθμός εβδομάδων ανά έτος εισοδήματος</td>" + 
                        "<td>" + data.fin_effort.income_per_type + "</td></tr>" +
                        "<tr><td>Μέσος όρος καθαρού εισοδήματος ανά μήνα</td>" + 
                        "<td>" + currencyShow(data.fin_effort.aver_income_per_month.toFixed(1)) + "</td></tr>"+
                        "<tr><td>Μέσος όρος καθαρού εισοδήματος ανά έτος</td>" + 
            ...
            break;  
        case 'hour':
            varResult+= "<tr><td>Καθαρό εισόδημα ανά ώρα</td>" + 
                        "<td style=\"width:20%\">" + currencyShow(data.fin_effort.income) + "</td></tr>"+
                        "<tr><td>Αριθμός ωρών ανά εβδομάδα εισοδήματος</td>" + 
                        "<td>" + data.fin_effort.income_hours_per_week + " ω.</td></tr>"+
                        "<tr><td>Αριθμός εβδομάδων ανά έτος εισοδήματος</td>" + 
                        "<td>" + data.fin_effort.income_per_type + "</td></tr>"+
                        "<tr><td>Μέσος όρος καθαρού εισοδήματος ανά μήνα</td>" + 
                        "<td>" + currencyShow(data.fin_effort.aver_income_per_month.toFixed(1)) + "</td></tr>"+
    ...
    if(f3.income_type != 'hour'){
        varResult+=     "<tr><td colspan=\"2\"><b>Χρόνος εργασίας</b></tr>";
        if(f3.is_working_time == 'true'){
            varResult+= "<tr><td>Ώρες ανά εβδομάδα</td>" +
                        "<td>"+data.fin_effort.time_hours_per_week+" ω.</td></tr>" +
                        "<tr><td>Μήνες ανά έτος</td>" + 
                        "<td>"+data.fin_effort.time_month_per_year+"</td></tr>" +
                        "<tr><td>Μέσος όρος ωρών εργασίας ανά μήνα</td>" + 
                        "<td>"+data.fin_effort.aver_work_time_per_m.toFixed(1)+" ω.</td></tr>" +
                        "<tr><td>Ώρες εργασίας ανά έτος</td>" + 
                        "<td>"+data.fin_effort.work_hours_per_y.toFixed(1)+" ω.</td></tr>";
        }
        else{
            varResult+= "<tr><td colspan=\"2\">Για να γίνει ο υπολογισμός τέθηκε ως δεδομένο ένας μέσος όρος 36 ωρών την εβδομάδα και 11 μηνών ετησίως</td></tr>";
        }
    }           
    varResult+= "<tr><td>Μέσος όρος καθαρού εισοδήματος ανά ώρα</td>" +
                "<td>&nbsp;" + currencyShow(data.fin_effort.aver_income_per_hour.toFixed(1)) + "</td></tr>";
    
    //distance
    varResult+= "<tr><td colspan=\"2\"><b>Απόσταση</b></td></tr>";
    if((f2.type_calc_fuel != 'km' && f3.drive_to_work == 'true') || (f2.type_calc_fuel != 'km' && f2.take_car_to_job == 'true')){   
        varResult+=  "<tr><td>Οδηγείτε από το σπίτι στην εργασία σας</td>"  +  
                     "<td>" + parseInt(f3.dist_home_job).toFixed(1) + " χλμ</td></tr>"+
                     "<tr><td>Ημέρες ανά εβδομάδα που πηγαίνετε στην εργασία σας με το αυτοκίνητο</td>"  +  
                     "<td>" + f3.drive_to_work_days_per_week + " ημέρες</td></tr>" +
                     "<tr><td>Οδηγείτε τις ημέρες που δεν παίρνετε το αυτοκίνητό στην εργασία σας</td>" + 
                     "<td>" + parseInt(f3.journey_weekend).toFixed(1) + " χλμ</td></tr>"+
                     "<tr><td>Οδηγείτε κατα μέσο όρο την εβδομάδα</td>" + 
                     "<td>" + data.driving_distance.aver_drive_per_week.toFixed(1) + " χλμ</td></tr>";                  
    }

    varResult+=  "<tr><td>Οδηγείτε ανά μήνα</td>" +
                 "<td>" + data.distance_per_month.toFixed(1) + " χλμ</td></tr>" +
                 "<tr><td>Οδηγείτε ανά έτος</td>" + 
                 "<td>" + data.driving_distance.drive_per_year.toFixed(1) + " χλμ</td></tr>";  

    //time spent in driving
    varResult+=  "<tr><td colspan=\"2\"><b>Χρόνος που αφιερώνετε στην οδήγηση</b></td></tr>";

    if(f3.drive_to_work == 'true' || f2.take_car_to_job == 'true'){
        varResult+= "<tr><td>Λεπτά που οδηγείτε για να μεταβείτε από το σπίτι στην εργασία σας</td>" + 
                    "<td>" + f3.time_home_job + " λπτ</td></tr>" +
                    "<tr><td>Ημέρες την εβδομάδα που πηγαίνετε στην εργασία σας με το αυτοκίνητο</td>" + 
                    "<td>" + f3.drive_to_work_days_per_week + " ημέρες</td></tr>" +
                    "<tr><td>Λεπτά που οδηγείτε τις ημέρες που δεν πηγαίνετε με το αυτοκίνητο στη δουλειά σας</td>" + 
                    "<td>" + f3.time_weekend + " λπτ</td></tr>" +
                    "<tr><td>Λεπτά που οδηγείτε ανά εβδομάδα</td>" + 
                    "<td>" + data.time_spent_driving.min_drive_per_week + " λπτ</td></tr>";
    }
    else{
        varResult+= "<tr><td>Λεπτά που οδηγείτε ανά ημέρα</td>" + 
                    "<td>" + f3.min_drive_per_day + " λπτ</td></tr>" +
                    "<tr><td>Ημέρες που οδηγείτε ανά μήνα</td>" + 
                    "<td>" + f3.days_drive_per_month + " ημέρες</td></tr>";
    }

    varResult+= "<tr><td>Ώρες που οδηγείτε ανά μήνα</td>" + 
                "<td>" + data.time_spent_driving.hours_drive_per_month.toFixed(1) + " ω.</td></tr>"+
                "<tr><td>Ώρες που οδηγείτε ανά έτος</td>" + 
                "<td>" + data.time_spent_driving.hours_drive_per_year.toFixed(1) + " ω.</td></tr>";

    //financial effort
    varResult+= "<tr><td colspan=\"2\"><b>Χρηματοδότηση" +
                ': ' + (data.total_costs_year/data.fin_effort.income_per_year*100).toFixed(0) + 
                '&#37;</b>' +
                "<tr><td>Συνόλικό ετήσιο κόστος του οχήματος</td>" + 
                "<td>" + currencyShow(data.fin_effort.total_costs_year.toFixed(1)) + "</td></tr>" +
                "<tr><td>Ώρες που χρειάζεται να εργάζεστε ετησίως ώστε να μπορείτε να συντηρείτε το αυτοκίνητό σας</td>"  +  
                "<td>" + data.fin_effort.hours_per_year_to_afford_car.toFixed(1) + " ω.</td></tr>"+
                "<tr><td>Μήνες που χρειάζεται να εργάζεστε ετησίως ώστε να μπορείτε να συντηρείτε το αυτοκίνητό σας</td>" +  
                "<td>" + data.fin_effort.month_per_year_to_afford_car.toFixed(2)+"</td></tr>"+
                "<tr><td>Για πόσες ημέρες, μέτα την 1η Ιανουαρίου, καταβάλετε χρήματα για το αυτοκίνητο</td>" +  
                "<td>" + Math.ceil(data.fin_effort.days_car_paid) + " ημέρες</td></tr>";
           

    //speed
    varResult+= "<tr><td>Μέσος όρος ετησίως ταχύτητα κίνησης</td>"+
                "<td>" + data.kinetic_speed.toFixed(1) + " χλμ/h</td></tr>";
                        
    varResult+= "<tr><td>Μέσος όρος ετησίως <a href=\"./docs/consumer_speed.html\" target=\"_blank\">εικονική ταχύτητα</a></td>"+
                "<td>" + data.virtual_speed.toFixed(1) + " χλμ/h</td></tr>";
...
function print_AlternativeToCarCosts_table(f1, f2, f3, data, country){
    ...
    if(data.public_transports.display_pt()) {
        ...
        tp_text = "<b>Μέσα μαζικής μεταφοράς για την καθημερινότητα της οικογένειάς σας</b><br>Αριθμός ατόμων στην οικογένειά σας που είναι άνω των 4 ετών: " + 
                  f3.n_pess_familia + " άτομο(-α)" +
                  "<br>Μέσο κόστος μηνιαίας κάρτας μεταφορών ανά άτομο: " + 
                  f3.monthly_pass_cost + "&euro;";
        
        if(data.public_transports.pt_carcost_ratio < data.public_transports.other_pt_ratio_threshold){
            outros_tp_text="<b>Άλλο μέσο μαζικής μεταφοράς</b><br>Ποσό από άλλο είδος μαζικής μεταφοράς, για παράδειγμα εκτός της περιοχής που μένετε, όπως μεγάλα ταξίδια με τρένο ή λεωφορείο ";
        }
        taxi_text="<b>Μεταφορά με ταξί<\/span><\/b><br>" + data.public_transports.km_by_taxi.toFixed(1) + " χλμ πληρώνοντας για ταξί " + data.public_transports.taxi_price_per_km.toFixed(1) + "&euro;/χλμ";
        
        //starts HTML table
        varResult+="<table class=\"result_table\" id=\"result_table2\">";
        //header
        varResult+="<tr><td><b>Κόστος</b><br></td>"+
                   "<td><b>Μηνιαίο ποσό</b></td></tr>";
        //items
        ...
        varResult+="<tr><td style=\"padding:6px 10px 6px 0;\"><b>ΣΥΝΟΛΟ</b></td>"+
                   "<td><b>" + currencyShow(data.public_transports.total_altern.toFixed(0)) + "/μήνα</b></td></tr>";
    ...
    if(UBER_SWITCH){
        ...
        if (res_uber_obj){
            ...
            if(res_uber_obj.result_type==1){
                ...
                varResult+="<tr><td><b>UBER - Κόστος ανά χιλιόμετρα</b>" + uber_url_HTML + "</td>" + 
                           "<td>" + currencyShow(res_uber_obj.ucd.toFixed(2)) + "/" + "χλμ</td></tr>";
                
                varResult+="<tr><td><b>UBER - Κόστος ανά λεπτά</b>" + uber_url_HTML + "</td>" + 
                           "<td>" + currencyShow(res_uber_obj.ucm.toFixed(2)) + "/" + "λπτ</td></tr>";

                varResult+="<tr><td><b>Χιλιόμετρα που διανύετε ανά μήνα</b><br></td>"+
                           "<td>" + res_uber_obj.dpm.toFixed(0) + " " +"χιλιόμετρα</td></tr>";
                
                           
                varResult+="<tr><td><b>Λεπτά που οδηγείτε ανά μήνα</b></td>" + 
                           "<td>" + res_uber_obj.mdpm.toFixed(0) + " " + "λεπτά</td></tr>";
                           
                varResult+="<tr><td><b>UBER: Κόστος - ΣΥΝΟΛΟ</b></td>" + 
                           "<td><b>" + currencyShow(res_uber_obj.tuc.toFixed(0)) + "</b></td></tr>";                     

                varResult+="<tr><td><b>Άλλο μέσο μαζικής μεταφοράς</b><br>Ποσό από άλλο είδος μαζικής μεταφοράς, για παράδειγμα εκτός της περιοχής που μένετε, όπως μεγάλα ταξίδια με τρένο ή λεωφορείο</td>" + 
                           "<td><b>" + currencyShow(res_uber_obj.delta.toFixed(0)) + "</b></td></tr>";
                
                varResult+="<tr><td><b>ΣΥΝΟΛΟ</b></td>"+
                           "<td><b>" + currencyShow(data.total_costs_month.toFixed(0)) + "/μήνα</b></td></tr>";
            ...
            //the case where uber equivalent is more expensive
                ...
                varResult+="<tr><td><b>Μέσα μαζικής μεταφοράς για την καθημερινότητα της οικογένειάς σας</b><br>Αριθμός ατόμων στην οικογένειά σας που είναι άνω των 4 ετών: " + f3.n_pess_familia + " άτομο(-α)" +
                           "<br>Μέσο κόστος μηνιαίας κάρτας μεταφορών ανά άτομο: " + f3.monthly_pass_cost + "&euro;</td>" +
                ...
                varResult+="<tr><td><b>Tαχύτητα κίνησης</b></td>" + 
                           "<td>" + data.kinetic_speed.toFixed(2) + " " +"χλμ/ω.</td></tr>";
                           
                varResult+="<tr><td><b>UBER - χιλιόμετρα ανά μήνα</b></td>" + 
                           "<td>" + res_uber_obj.dist_uber.toFixed(0) + " " + "χιλιόμετρα</td></tr>";
...
function print_extern_table(f1, f2, f3, data){ 
    ...
    var epa_text      = "<b>Emissões de poluentes atmosféricos</b><br>Valor aproximado: " + data.external_costs.polution + "&euro;/χλμ";
    var egee_text     = "<b>Emissões de gases de efeito de estufa</b><br>Valor aproximado: " + data.external_costs.ghg + "&euro;/χλμ";
    var ruido_text    = "<b>Poluição sonora</b><br>Valor aproximado: " + data.external_costs.noise + "&euro;/χλμ";
    var sr_text       = "<b>Sinistralidade rodoviária</b><br>Valor aproximado: " + data.external_costs.fatalities + "&euro;/χλμ";
    var cgstn_text    = "<b>Congestionamento<\/span></b><br>Valor aproximado: " + data.external_costs.congestion + "&euro;/χλμ";
    var ifr_estr_text = "<b>Desgaste das infraestruturas rodoviárias</b><br>Valor aproximado: " + data.external_costs.infrastr + "&euro;/χλμ";
    ...
    if(Country=="PT" && isDef(data.distance_per_month)){
        ...
        //header
        varResult+="<tr><td><b>Custos externos</b><br>Percorre " +(1 * data.distance_per_month).toFixed(1)+" χλμ/μήνα</td>" +
                   "<td><b>Μηνιαίο ποσό</b></td></tr>";
        ...
        varResult+="<tr><td>" + ifr_estr_text + "</td>" + 
         ...
         //total
        varResult+="<tr><td style=\"padding:6px 10px 6px 0;\"><b>ΣΥΝΟΛΟ</b></td>" +
                   "<td><b>&euro;&nbsp;"+data.external_costs.total_exter().toFixed(0)+"/μήνα</b></td></tr>";
