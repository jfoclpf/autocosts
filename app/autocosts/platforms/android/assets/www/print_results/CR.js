...
function Run2(callback){
    ...
    if(SOCIAL_SWITCH){
        $("#shareIcons").jsSocials({
            url: 'http://autocostos.info/CR',
            text: 'Esta calculadora te permitirá conocer el verdadero costo de ser propietario de un vehículo en Costa Rica',
            showLabel: false,
            showCount: false,
...
function print_costs_table(f1, f2, f3, data) {
    ...
    if (f1.nmr_times_inspec !== 0){
        inspection_text = "<b>Revisión Técnica Vehicular (RTV)</b><br>" +
                          f1.nmr_times_inspec +
                          " veces, costando " +
                          f1.inspec_price +
                          " ₡ cada una durante " +
    ...
    varResult+= "<tr><td><b>Seguro vehicular y SOAT</b><br>" + insurance_text + "</td>" +
