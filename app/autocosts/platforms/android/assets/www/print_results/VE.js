...
function Run2(callback){
    ...
    if(SOCIAL_SWITCH){
        $("#shareIcons").jsSocials({
            url: 'http://autocostos.info/VE',
            text: 'Esta calculadora te permitirá conocer el verdadero costo de ser propietario de un vehículo en Venezuela',
            showLabel: false,
            showCount: false,
...
function print_costs_table(f1, f2, f3, data) {
    ...
    if (data.age_months === 0) {    
        ...
        depreciation_text = "<b>Depreciación del vehículo<\/span></b>&nbsp;&nbsp;<br>Precio de compra: "+
            f1.auto_initial_cost + "Bs<br>Precio de hoy: "+
            f1.auto_final_cost + "Bs<br>Periodo de posesión: "+
            data.age_months + " meses<br>("+
            f1.auto_initial_cost + "Bs-"+
            f1.auto_final_cost + "Bs)/"+
    ...
    {
        case "semestral":
            insurance_text = f1.insurance_value + " Bolívares por semestre";
            break;
        case "anual":
            insurance_text = f1.insurance_value + " Bolívares por año";
            break;
        case "mensal":
            insurance_text = data.monthly_costs.insurance + " Bolívares por mes";
            break;
        case "trimestral":
            insurance_text = f1.insurance_value + " Bolívares por trimestre";
            break;
    }
    ...
    if(f1.cred_auto_s_n == "true") {
        ...
        interests_text = "<b>Intereses del préstamo</b>&nbsp;&nbsp;<br>Cuota financiada: " +
                         f1.credit_amount +
                         "Bs<br>Periodo de crédito / cantidad de cuotas: " +
                         f1.credit_period +
                         " meses<br>Valor promedio mensual: " +
                         f1.credit_value_p_month +
                         "Bs<br>Valor residual: " +
                         f1.credit_residual_value +
                         "Bs<br>";    

        interests_text += "Importe total de intereses: "+data.total_interests+"Bs<br>(" + data.month_cred + "*"+ f1.credit_value_p_month + ")+" + f1.credit_residual_value + "-" + f1.credit_amount;

        if(data.age_months >= data.month_cred)
            interests_text += "<br>Cuota mensual de intereses: "+data.monthly_costs.credit.toFixed(2)+"Bs";
        interests_text += "";
    } 
    ...
    if (f1.nmr_times_inspec !== 0){
        inspection_text = "<b>Revisión Técnica Vehicular</b><br>" +
                          f1.nmr_times_inspec +
                          " veces, costando " +
                          f1.inspec_price +
                          " Bs cada una durante " +
            ...
            if (f2.take_car_to_job == "false"){
                switch(data.fuel_period_km)
                {
                    case "1":
                        ...
                        break;
                    case "2":                   
                        fuel_text = f2.distance + " kilómetros por bimestre";
                        break;
                    case "3":                   
                ...
                fuel_text = fuel_text + "<br>" + "Precio medio del combustible: " + f2.fuel_price + " Bs/l&nbsp;&nbsp;";
            }
            else{
                ...
                fuel_text = fuel_text + "Conduces " + f2.distance_weekend + " kilómetros promedio de los días que no utilizas el vehículo para ir al trabajar&nbsp;<br>";
                ...
                fuel_text = fuel_text + "<br>" + "Gasto promedio en combustible: " + f2.fuel_price + " Bs/l";
            }
            break;
        case "euros":
            ...
            {
                case "1":
                    fuel_text = f2.fuel_money + " Bolívares por mes";
                    break;
                case "2":                   
                    fuel_text = f2.fuel_money + " kilómetros por bimestre";
                    break;
                case "3":                   
                    fuel_text = f2.fuel_money + " Bolívares por trimestre";
                    break;
                case "4":                   
                    fuel_text = f2.fuel_money + " Bolívares por semestre";
                    break;
                case "5":                   
                    fuel_text = f2.fuel_money + " Bolívares por año";
                    break;
            }
            break;
    }
    ...
    var maintenance_text = "<b>1/2 Mantenimiento</b><br>" +
                           f2.maintenance + " Bolívares por año";
    
    //Repairs
    var repairs_text = "<b>Reparaciones y mejoras<\/span></b><br>" +
                       f2.repairs + " Bolívares por año";
    ...
    if(f2.type_calc_tolls == "false") {
        switch(data.tolls_period) {
            case "1":
                tolls_text += f2.tolls + " Bolívares por mes";
                break;
            case "2":
                tolls_text += f2.tolls + " Bolívares por cada bimestre";
                break;
            case "3":
                tolls_text += f2.tolls + " Bolívares por trimestre";
                break;
            case "4":
                tolls_text += f2.tolls + " Bolívares por semestre";
                break;
            case "5":
                tolls_text += f2.tolls + " Bolívares por año";
                break;
        }
    }
    else 
        tolls_text+=f2.price_tolls_p_day + " Bolívares durante " + f2.tolls_days_p_month + " mes";
    tolls_text += "";
    ...
    switch(data.fines_period) {
        case "1":           
            fines_text += f2.fines + " Bolívares por mes";
            break;
        case "2":           
            fines_text += f2.fines + " Bolívares por cada bimestre";
            break;
        case "3":           
            fines_text += f2.fines+" Bolívares por trimestre";
            break;
        case "4":           
            fines_text += f2.fines + " Bolívares por semestre";
            break;
        case "5":           
            fines_text += f2.fines + " Bolívares por año";
            break;
        }
    fines_text+="";
    ...
    switch(data.washing_period) {
        case "1":
            washing_text += f2.washing + " Bolívares por mes";
            break;
        case "2":
            washing_text += f2.washing + " Bolívares por cada bimestre";
            break;
        case "3":
            washing_text += f2.washing +" Bolívares por trimestre";
            break;
        case "4":
            washing_text += f2.washing + " Bolívares por semestre";
            break;
        case "5":
            washing_text += f2.washing + " Bolívares por año";
            break;
        }
    washing_text+="";
...
function print_feffort_table(f1, f2, f3, data){
    ...
    if((f2.type_calc_fuel != 'km' && f3.drive_to_work == 'true') || (f2.type_calc_fuel != 'km' && f2.take_car_to_job == 'true')){   
        varResult+=  "<tr><td>Conduces de casa al trabajo</td>"  +  
                     ...
                     "<tr><td>Distancia que recorres los días que no vas que no vas a trabajar en tu vehículo</td>" + 
    ...
    if(f3.drive_to_work == 'true' || f2.take_car_to_job == 'true'){
        varResult+= "<tr><td>Cantidad de minutos que manejas para llegar de casa al trabajo</td>" + 
                    ...
                    "<tr><td>Cantidad de días por semana que vas en tu vehículo al trabajo</td>" + 
                    "<td>" + f3.drive_to_work_days_per_week + " días</td></tr>" +
                    "<tr><td>Cantidad de minutos empleados en conducción los días que no vas en tu vehículo al trabajo</td>" + 
...
function print_AlternativeToCarCosts_table(f1, f2, f3, data, country){
    ...
    if(data.public_transports.display_pt()) {
        ...
        taxi_text="<b>Transporte en taxi<\/span><\/b><br>" + data.public_transports.km_by_taxi.toFixed(1) + " km en taxi pagando " + data.public_transports.taxi_price_per_km.toFixed(1) + "Bs/km";
        ...
        if (res_uber_obj){
            ...
            //the case where uber equivalent is more expensive
                ...
                varResult+="<tr><td><b>Transporte público en la vida diaria de tu familia</b><br>Cantidad de miembros de tu familia mayores de 4 años: " + f3.n_pess_familia + " persona(s)" +
                           "<br>Promedio de gastos en el abono mensual por persona: " + f3.monthly_pass_cost + "Bs</td>" +
...
function print_extern_table(f1, f2, f3, data){ 
    ...
    var epa_text      = "<b>Emissões de poluentes atmosféricos</b><br>Valor aproximado: " + data.external_costs.polution + "Bs/km";
    var egee_text     = "<b>Emissões de gases de efeito de estufa</b><br>Valor aproximado: " + data.external_costs.ghg + "Bs/km";
    var ruido_text    = "<b>Poluição sonora</b><br>Valor aproximado: " + data.external_costs.noise + "Bs/km";
    var sr_text       = "<b>Sinistralidade rodoviária</b><br>Valor aproximado: " + data.external_costs.fatalities + "Bs/km";
    var cgstn_text    = "<b>Congestionamento<\/span></b><br>Valor aproximado: " + data.external_costs.congestion + "Bs/km";
    var ifr_estr_text = "<b>Desgaste das infraestruturas rodoviárias</b><br>Valor aproximado: " + data.external_costs.infrastr + "Bs/km";
    ...
    if(Country=="PT" && isDef(data.distance_per_month)){
        ...
        varResult+="<tr><td>" + epa_text + "</td>" +   
                   "<td>&nbsp;Bs " + (data.external_costs.polution * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + egee_text + "</td>" + 
                   "<td>&nbsp;Bs " + (data.external_costs.ghg * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + ruido_text + "</td>" + 
                   "<td>&nbsp;Bs " + (data.external_costs.noise * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + sr_text + "</td>" + 
                   "<td>&nbsp;Bs " + (data.external_costs.fatalities * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + cgstn_text + "</td>" + 
                   "<td>&nbsp;Bs " + (data.external_costs.congestion * data.distance_per_month).toFixed(1)+"</td></tr>";
                
        varResult+="<tr><td>" + ifr_estr_text + "</td>" + 
                   "<td>&nbsp;Bs " + (data.external_costs.infrastr * data.distance_per_month).toFixed(1)+"</td></tr>";
        
         //total
        varResult+="<tr><td style=\"padding:6px 10px 6px 0;\"><b>TOTAL</b></td>" +
                   "<td><b>Bs&nbsp;"+data.external_costs.total_exter().toFixed(0)+"/mes</b></td></tr>";
