...
function Run2(callback){
    ...
    if(SOCIAL_SWITCH){
        $("#shareIcons").jsSocials({
            url: 'http://autocosts.info/UA',
            text: 'За допомогою цього симулятора ви можете дізнатися реальну вартість утримання автомобіля в Україні',
            showLabel: false,
            showCount: false,
...
function print_result_final_text(data){
    ...
    if(data.total_costs_month >= 150 && data.age_months > 6) {
        ...
        var text_msg = '<div>З таким рівнем витрат вартість утримання вашого автомобіля за '+
                       '<b>' + data.age_months + '</b> місяці(в) уже склала:</div>'+
...
function print_costs_table(f1, f2, f3, data) {
    ...
    if (data.age_months === 0) {    
        depreciation_text = "Вартість не знижується, бо цей автомобіль новий&nbsp;&nbsp;";
    } else {
        depreciation_text = "<b>Зниження вартості автомобіля<\/span></b>&nbsp;&nbsp;<br>Вартість на момент придбання: "+
            f1.auto_initial_cost + "₴<br>Вартість на сьогодні: "+
            f1.auto_final_cost + "₴<br>Тривалість утримання: "+
            data.age_months + " місяці(в)<br>("+
            f1.auto_initial_cost + "₴-"+
            f1.auto_final_cost + "₴)/"+
            data.age_months + " місяці(в)";
    }
    ...
    {
        case "semestral":
            insurance_text = f1.insurance_value + " гривні на півроку";
            break;
        case "anual":
            insurance_text = f1.insurance_value + " гривні на рік";
            break;
        case "mensal":
            insurance_text = data.monthly_costs.insurance + " гривні на місяць";
            break;
        case "trimestral":
            insurance_text = f1.insurance_value + " гривні на три місяці";
            break;
    }
    
    //Credit interests
    var interests_text="<b>Відсотки за кредитом<\/b>&nbsp;&nbsp;";
    
    if(f1.cred_auto_s_n == "true") {

        interests_text = "<b>Відсотки за кредитом</b>&nbsp;&nbsp;<br>Сума фінансування: " +
                         f1.credit_amount +
                         "₴<br>Термін кредиту / кількість внесків у погашення кредиту: " +
                         f1.credit_period +
                         " місяці(в)<br>Середнє значення на місяць: " +
                         f1.credit_value_p_month +
                         "₴<br>Остаточна вартість: " +
                         f1.credit_residual_value +
                         "₴<br>";    

        interests_text += "Загальна сума відсотків: "+data.total_interests+"₴<br>(" + data.month_cred + "*"+ f1.credit_value_p_month + ")+" + f1.credit_residual_value + "-" + f1.credit_amount;

        if(data.age_months >= data.month_cred)
            interests_text += "<br>Сума відсотків на місяць: "+data.monthly_costs.credit.toFixed(2)+"₴";
        interests_text += "";
    } 
    ...
    if (f1.nmr_times_inspec !== 0){
        inspection_text = "<b>Технічний огляд автомобіля (державний техогляд)</b><br>" +
                          f1.nmr_times_inspec +
                          " рази вартістю " +
                          f1.inspec_price +
                          " ₴ за кожний протягом " +
    ...
    //Taxes
    var cartax_text = "<b>Акциз (податок) на автомобіль</b><br>" +
                      f1.car_tax + " гривні на рік";
    ...
    switch(f2.type_calc_fuel){
        case "km":                     
            if (f2.take_car_to_job == "false"){
                ...
                {
                    case "1":
                        fuel_text = f2.distance + " км на місяць";
                        break;
                    case "2":                   
                        fuel_text = f2.distance + " кілометри на кожні два місяці";
                        break;
                    case "3":                   
                        fuel_text = f2.distance + " км на три місяці";
                        break;
                    case "4":                   
                        fuel_text = f2.distance + " км на півроку";
                        break;
                    case "5":                   
                        fuel_text = f2.distance + " км на рік";
                        break;
                }
                fuel_text = fuel_text + "<br>" + "Рівень споживання пального вашого автомобіля: " + f2.car_consumption + " л/100 км&nbsp;";
                fuel_text = fuel_text + "<br>" + "Середня ціна на пальне: " + f2.fuel_price + " ₴/л&nbsp;&nbsp;";
            }
            else{
                fuel_text = f2.days_p_week + " Дні(в), коли ви їздите на роботу автомобілем <br>";
                fuel_text = fuel_text + "Ви проїздите автомобілем " + f2.distance_home2job + " Відстань у кілометрах між домом і роботою <br>";
                fuel_text = fuel_text + "Ви проїздите автомобілем " + f2.distance_weekend + " Середня відстань у кілометрах у ті дні, коли не їдете на роботу автомобілем&nbsp;<br>";
                fuel_text = fuel_text + "Усього ви проїздите автомобілем у середньому " + data.distance_per_month.toFixed(1) + " км на місяць (~30.5 дні(в)) <br>";
                fuel_text = fuel_text + "Рівень споживання пального вашого автомобіля: " + f2.car_consumption + " л/100 км";
                fuel_text = fuel_text + "<br>" + "Середня ціна, за якою ви купляєте пальне: " + f2.fuel_price + " ₴/л";
            }
            break;
        case "euros":
            ...
            {
                case "1":
                    fuel_text = f2.fuel_money + " гривні на місяць";
                    break;
                case "2":                   
                    fuel_text = f2.fuel_money + " кілометри на кожні два місяці";
                    break;
                case "3":                   
                    fuel_text = f2.fuel_money + " гривні на три місяці";
                    break;
                case "4":                   
                    fuel_text = f2.fuel_money + " гривні на півроку";
                    break;
                case "5":                   
                    fuel_text = f2.fuel_money + " гривні на рік";
                    break;
            }
            break;
    }
    ...
    //Maintenance
    var maintenance_text = "<b>1/2 Технічне обслуговування</b><br>" +
                           f2.maintenance + " гривні на рік";
    
    //Repairs
    var repairs_text = "<b>Ремонт і вдосконалення<\/span></b><br>" +
                       f2.repairs + " гривні на рік";
    
    //Tolls
    var tolls_text="<b>Плата за проїзд</b><br>";
    if(f2.type_calc_tolls == "false") {
        switch(data.tolls_period) {
            case "1":
                tolls_text += f2.tolls + " гривні на місяць";
                break;
            case "2":
                tolls_text += f2.tolls + " гривні за два місяці";
                break;
            case "3":
                tolls_text += f2.tolls + " гривні на три місяці";
                break;
            case "4":
                tolls_text += f2.tolls + " гривні на півроку";
                break;
            case "5":
                tolls_text += f2.tolls + " гривні на рік";
                break;
        }
    }
    else 
        tolls_text+=f2.price_tolls_p_day + " гривні під час " + f2.tolls_days_p_month + " місяць";
    tolls_text += "";
    
    //Fines
    var fines_text="<b>Штрафи за порушення ПДР</b><br>";
    switch(data.fines_period) {
        case "1":           
            fines_text += f2.fines + " гривні на місяць";
            break;
        case "2":           
            fines_text += f2.fines + " гривні за два місяці";
            break;
        case "3":           
            fines_text += f2.fines+" гривні на три місяці";
            break;
        case "4":           
            fines_text += f2.fines + " гривні на півроку";
            break;
        case "5":           
            fines_text += f2.fines + " гривні на рік";
            break;
        }
    fines_text+="";
    
    //washing
    var washing_text="<b>Миття та чистка</b><br>";
    switch(data.washing_period) {
        case "1":
            washing_text += f2.washing + " гривні на місяць";
            break;
        case "2":
            washing_text += f2.washing + " гривні за два місяці";
            break;
        case "3":
            washing_text += f2.washing +" гривні на три місяці";
            break;
        case "4":
            washing_text += f2.washing + " гривні на півроку";
            break;
        case "5":
            washing_text += f2.washing + " гривні на рік";
            break;
        }
    washing_text+="";
    ...
    varResult+= "<tr><td style=\"padding:10px 50px;\" colspan=\"2\"><b>Постійні витрати</b><br>" +
                "<i>Витрати, які не залежать від пробігу і які здійснюються навіть тоді, коли автомобіль не експлуатується</i></td></tr>";
    
    //Costs || Monthly amount
    varResult+= "<tr><td style=\"padding:10px 15px 10px 15px;\"><b>Витрати</b></td>" +
                "<td><b>Сумма на місяць</b></td></tr>";
    
    //standing costs items
    varResult+= "<tr><td>" + depreciation_text + "&nbsp;</td>" + 
                "<td>&nbsp;" + currencyShow(data.monthly_costs.depreciation.toFixed(1)) + "</td></tr>";
    
    varResult+= "<tr><td><b>Страхування автомобіля і страхове покриття на випадок пошкоджень у дорозі</b><br>" + insurance_text + "</td>" +
    ...
    varResult+= "<tr><td style=\"padding:4px 10px 4px 0;\"><b>Постійні витрати - РАЗОМ</b></td>"+
                "<td>&nbsp;<b>" + currencyShow(data.total_standing_costs_month.toFixed(0)) + "/місяць</b></td></tr>";
    ...
    varResult+= "<tr><td style=\"padding:10px 15px;\" colspan=\"2\"><b>Експлуатаційні витрати</b><br>" +
                "<i>Витрати, які залежать від пробігу</i></td></tr>";
                  
    //Costs || Monthly amount
    varResult+= "<tr><td style=\"padding:10px 15px 10px 15px;\"><b>Витрати</b></td>" +
                "<td><b>Сумма на місяць</b></td></tr>";

    varResult+= "<tr><td><b>Пальне</b><br>" + fuel_text + "</td>" +
    ...
    //TOTAL - Running costs
    varResult+= "<tr><td style=\"padding:4px 10px 4px 0;\"><b>Експлуатаційні витрати - РАЗОМ</b></td>"+
                "<td>&nbsp;<b>" + currencyShow(data.total_running_costs_month.toFixed(0)) + "/місяць</b></td></tr>";
    ...
    varResult+= "<tr><td style=\"padding:10px 15px;\" colspan=\"2\"><b>РАЗОМ</b><br></td></tr>"; 

    if((typeof data.distance_per_month) !== 'undefined' && data.distance_per_month !== 0){
              
        varResult+= "<tr><td><b>Експлуатаційні витрати на кілометр</b></td>"+
                    "<td>&nbsp;" + currencyShow(data.running_costs_p_unit_distance.toFixed(2)) + "/км </td></tr>";
        
        varResult+= "<tr><td class=\"border_bottom_2px\"><b>Усього витрат на кілометр</b></td>" +
                    "<td class=\"border_bottom_2px\">&nbsp;" + currencyShow(data.total_costs_p_unit_distance.toFixed(2)) + "/км </td></tr>";
    }

    varResult+= "<tr><td><b>Постійні витрати</b></td>"+
                "<td>&nbsp;<b>" + currencyShow(data.total_standing_costs_month.toFixed(0)) + "/місяць</b></td></tr>";
    
    varResult+= "<tr><td><b>Експлуатаційні витрати</b></td>"+
                "<td>&nbsp;<b>" + currencyShow(data.total_running_costs_month.toFixed(0)) + "/місяць</b></td></tr>";    
    
    varResult+="<tr><td style=\"padding:6px 10px 6px 0;\"><b>РАЗОМ</b></td>"+
               "<td>&nbsp;<b>" + currencyShow(data.total_costs_month.toFixed(0)) + "/місяць</b></td></tr>";
...
function print_feffort_table(f1, f2, f3, data){
    ...
    varResult+="<tr><td colspan=\"2\"><b>Фінансове зусилля</b></td></tr>";
    //income
    varResult+="<tr><td colspan=\"2\"><b>Дохід</b></tr>";
    switch(f3.income_type){
        case 'year':    
            varResult+= "<tr><td>Чистий дохід на рік</td>" + 
                        "<td style=\"width:20%\">" + currencyShow(data.fin_effort.income) + "</td></tr>" +
                        "<tr><td>Середній чистий дохід на місяць</td>" + 
                        "<td>" + currencyShow(data.fin_effort.aver_income_per_month.toFixed(1)) + "</td></tr>";
            break;
        case 'month':
            varResult+= "<tr><td>Чистий дохід на місяць</td>" + 
                        "<td style=\"width:20%\">" + currencyShow(data.fin_effort.income) + "</td></tr>" +
                        "<tr><td>Кількість місяців у році отримання доходу</td>" + 
                        "<td>" + data.fin_effort.income_per_type + "</td></tr>" +
                        "<tr><td>Середній чистий дохід на місяць</td>" + 
                        "<td>" + currencyShow(data.fin_effort.aver_income_per_month.toFixed(1)) + "</td></tr>" +
                        "<tr><td>Середній чистий дохід на рік</td>" + 
                        "<td>" + currencyShow(data.fin_effort.income_per_year.toFixed(1)) + "</td></tr>";
            break;
        case 'week':
            varResult+= "<tr><td>Чистий дохід на тиждень</td>" + 
                        "<td style=\"width:20%\">" + currencyShow(data.fin_effort.income) + "</td></tr>"+
                        "<tr><td>Кількість тижнів у році отримання доходу</td>" + 
                        "<td>" + data.fin_effort.income_per_type + "</td></tr>" +
                        "<tr><td>Середній чистий дохід на місяць</td>" + 
                        "<td>" + currencyShow(data.fin_effort.aver_income_per_month.toFixed(1)) + "</td></tr>"+
                        "<tr><td>Середній чистий дохід на рік</td>" + 
            ...
            break;  
        case 'hour':
            varResult+= "<tr><td>Чистий дохід на година</td>" + 
                        "<td style=\"width:20%\">" + currencyShow(data.fin_effort.income) + "</td></tr>"+
                        "<tr><td>Кількість годин у тижні отримання доходу</td>" + 
                        "<td>" + data.fin_effort.income_hours_per_week + " г</td></tr>"+
                        "<tr><td>Кількість тижнів у році отримання доходу</td>" + 
                        "<td>" + data.fin_effort.income_per_type + "</td></tr>"+
                        "<tr><td>Середній чистий дохід на місяць</td>" + 
                        "<td>" + currencyShow(data.fin_effort.aver_income_per_month.toFixed(1)) + "</td></tr>"+
    ...
    if(f3.income_type != 'hour'){
        varResult+=     "<tr><td colspan=\"2\"><b>Робочий час</b></tr>";
        if(f3.is_working_time == 'true'){
            varResult+= "<tr><td>Годин(и) на тиждень</td>" +
                        "<td>"+data.fin_effort.time_hours_per_week+" г</td></tr>" +
                        "<tr><td>Місяці(в) на рік</td>" + 
                        "<td>"+data.fin_effort.time_month_per_year+"</td></tr>" +
                        "<tr><td>Середня кількість годин роботи на місяць</td>" + 
                        "<td>"+data.fin_effort.aver_work_time_per_m.toFixed(1)+" г</td></tr>" +
                        "<tr><td>Кількість годин роботи на рік</td>" + 
                        "<td>"+data.fin_effort.work_hours_per_y.toFixed(1)+" г</td></tr>";
        }
        else{
            varResult+= "<tr><td colspan=\"2\">Для цілей розрахунків середня тривалість роботи вважається рівною 36 годинам на тиждень і 11 місяцям на рік</td></tr>";
        }
    }           
    varResult+= "<tr><td>Середній чистий дохід на година</td>" +
                "<td>&nbsp;" + currencyShow(data.fin_effort.aver_income_per_hour.toFixed(1)) + "</td></tr>";
    
    //distance
    varResult+= "<tr><td colspan=\"2\"><b>Відстань</b></td></tr>";
    if((f2.type_calc_fuel != 'km' && f3.drive_to_work == 'true') || (f2.type_calc_fuel != 'km' && f2.take_car_to_job == 'true')){   
        varResult+=  "<tr><td>Ви проїздите автомобілем з дому на роботу</td>"  +  
                     "<td>" + parseInt(f3.dist_home_job).toFixed(1) + " км</td></tr>"+
                     "<tr><td>Кількість днів на тиждень, коли ви їдете автомобілем на роботу</td>"  +  
                     "<td>" + f3.drive_to_work_days_per_week + " дні(в)</td></tr>" +
                     "<tr><td>Ви проїздите автомобілем у дні, коли ви не їдете автомобілем на роботу</td>" + 
                     "<td>" + parseInt(f3.journey_weekend).toFixed(1) + " км</td></tr>"+
                     "<tr><td>У середньому на тиждень ви проїздите</td>" + 
                     "<td>" + data.driving_distance.aver_drive_per_week.toFixed(1) + " км</td></tr>";                  
    }

    varResult+=  "<tr><td>Ви проїздите на місяць</td>" +
                 "<td>" + data.distance_per_month.toFixed(1) + " км</td></tr>" +
                 "<tr><td>Ви проїздите на рік</td>" + 
                 "<td>" + data.driving_distance.drive_per_year.toFixed(1) + " км</td></tr>";  

    //time spent in driving
    varResult+=  "<tr><td colspan=\"2\"><b>Час за кермом</b></td></tr>";

    if(f3.drive_to_work == 'true' || f2.take_car_to_job == 'true'){
        varResult+= "<tr><td>Кількість хвилин, що ви проводите за кермом з дому на роботу</td>" + 
                    "<td>" + f3.time_home_job + " хв</td></tr>" +
                    "<tr><td>Кількість днів на тиждень, у які ви їздите на роботу автомобілем</td>" + 
                    "<td>" + f3.drive_to_work_days_per_week + " дні(в)</td></tr>" +
                    "<tr><td>Кількість хвилин, що ви проводите за кермом у дні, коли ви не їдете автомобілем на роботу</td>" + 
                    "<td>" + f3.time_weekend + " хв</td></tr>" +
                    "<tr><td>Кількість хвилин, що ви проводите за кермом на тиждень</td>" + 
                    "<td>" + data.time_spent_driving.min_drive_per_week + " хв</td></tr>";
    }
    else{
        varResult+= "<tr><td>Кількість хвилин, що ви проводите за кермом на день</td>" + 
                    "<td>" + f3.min_drive_per_day + " хв</td></tr>" +
                    "<tr><td>Кількість днів на місяць, у які ви їздите автомобілем</td>" + 
                    "<td>" + f3.days_drive_per_month + " дні(в)</td></tr>";
    }

    varResult+= "<tr><td>Кількість годин, що ви проводите за кермом на місяць</td>" + 
                "<td>" + data.time_spent_driving.hours_drive_per_month.toFixed(1) + " г</td></tr>"+
                "<tr><td>Кількість годин, що ви проводите за кермом на рік</td>" + 
                "<td>" + data.time_spent_driving.hours_drive_per_year.toFixed(1) + " г</td></tr>";

    //financial effort
    varResult+= "<tr><td colspan=\"2\"><b>Фінансове зусилля" +
                ': ' + (data.total_costs_year/data.fin_effort.income_per_year*100).toFixed(0) + 
                '&#37;</b>' +
                "<tr><td>Сума витрат на автомобіль у рік</td>" + 
                "<td>" + currencyShow(data.fin_effort.total_costs_year.toFixed(1)) + "</td></tr>" +
                "<tr><td>Кількість годин на рік, які вам потрібно відпрацювати, щоб дозволити собі мати автомобіль</td>"  +  
                "<td>" + data.fin_effort.hours_per_year_to_afford_car.toFixed(1) + " г</td></tr>"+
                "<tr><td>Кількість місяців на рік, які вам потрібно відпрацювати, щоб дозволити собі мати автомобіль</td>" +  
                "<td>" + data.fin_effort.month_per_year_to_afford_car.toFixed(2)+"</td></tr>"+
                "<tr><td>Через скільки днів, починаючи з 1 січня, буде оплачений автомобіль</td>" +  
                "<td>" + Math.ceil(data.fin_effort.days_car_paid) + " дні(в)</td></tr>";
           

    //speed
    varResult+= "<tr><td>У середньому в рік кінетична швидкість</td>"+
                "<td>" + data.kinetic_speed.toFixed(1) + " км/h</td></tr>";
                        
    varResult+= "<tr><td>У середньому в рік <a href=\"./docs/consumer_speed.html\" target=\"_blank\">віртуальна швидкість</a></td>"+
...
function print_AlternativeToCarCosts_table(f1, f2, f3, data, country){
    ...
    if(data.public_transports.display_pt()) {
        ...
        tp_text = "<b>Громадський транспорт для щоденної діяльності членів сім’ї</b><br>Кількість членів вашої сім’ї у віці від 4 років: " + 
                  f3.n_pess_familia + " людини (людей)" +
                  "<br>Середня вартість місячного абонементу на людину: " + 
                  f3.monthly_pass_cost + "₴";
        
        if(data.public_transports.pt_carcost_ratio < data.public_transports.other_pt_ratio_threshold){
            outros_tp_text="<b>Інші види громадського транспорту</b><br>Сума, що витрачається на інші види транспорту, наприклад, для поїздок із вашого звичайного району проживання, як от поїзди або автобуси дальнього слідування ";
        }
        taxi_text="<b>Поїздки на таксі<\/span><\/b><br>" + data.public_transports.km_by_taxi.toFixed(1) + " км на таксі за ціною " + data.public_transports.taxi_price_per_km.toFixed(1) + "₴/км";
        
        //starts HTML table
        varResult+="<table class=\"result_table\" id=\"result_table2\">";
        //header
        varResult+="<tr><td><b>Витрати</b><br></td>"+
                   "<td><b>Сумма на місяць</b></td></tr>";
        //items
        ...
        varResult+="<tr><td style=\"padding:6px 10px 6px 0;\"><b>РАЗОМ</b></td>"+
                   "<td><b>" + currencyShow(data.public_transports.total_altern.toFixed(0)) + "/місяць</b></td></tr>";
    ...
    if(UBER_SWITCH){
        ...
        if (res_uber_obj){
            ...
            if(res_uber_obj.result_type==1){
                ...
                varResult+="<tr><td><b>UBER - Витрати на кілометри</b>" + uber_url_HTML + "</td>" + 
                           "<td>" + currencyShow(res_uber_obj.ucd.toFixed(2)) + "/" + "км</td></tr>";
                
                varResult+="<tr><td><b>UBER - Витрати на хвилин(и)</b>" + uber_url_HTML + "</td>" + 
                           "<td>" + currencyShow(res_uber_obj.ucm.toFixed(2)) + "/" + "хв</td></tr>";

                varResult+="<tr><td><b>Відстань у кілометрах, яку ви проїздите автомобілем на місяць</b><br></td>"+
                           "<td>" + res_uber_obj.dpm.toFixed(0) + " " +"кілометри</td></tr>";
                
                           
                varResult+="<tr><td><b>Кількість хвилин, що ви проводите за кермом на місяць</b></td>" + 
                           "<td>" + res_uber_obj.mdpm.toFixed(0) + " " + "хвилин(и)</td></tr>";
                           
                varResult+="<tr><td><b>UBER: Витрати - РАЗОМ</b></td>" + 
                           "<td><b>" + currencyShow(res_uber_obj.tuc.toFixed(0)) + "</b></td></tr>";                     

                varResult+="<tr><td><b>Інші види громадського транспорту</b><br>Сума, що витрачається на інші види транспорту, наприклад, для поїздок із вашого звичайного району проживання, як от поїзди або автобуси дальнього слідування</td>" + 
                           "<td><b>" + currencyShow(res_uber_obj.delta.toFixed(0)) + "</b></td></tr>";
                
                varResult+="<tr><td><b>РАЗОМ</b></td>"+
                           "<td><b>" + currencyShow(data.total_costs_month.toFixed(0)) + "/місяць</b></td></tr>";
            ...
            //the case where uber equivalent is more expensive
                ...
                varResult+="<tr><td><b>Громадський транспорт для щоденної діяльності членів сім’ї</b><br>Кількість членів вашої сім’ї у віці від 4 років: " + f3.n_pess_familia + " людини (людей)" +
                           "<br>Середня вартість місячного абонементу на людину: " + f3.monthly_pass_cost + "₴</td>" +
                ...
                varResult+="<tr><td><b>Кінетична швидкість</b></td>" + 
                           "<td>" + data.kinetic_speed.toFixed(2) + " " +"км/г</td></tr>";
                           
                varResult+="<tr><td><b>UBER - кілометри на місяць</b></td>" + 
                           "<td>" + res_uber_obj.dist_uber.toFixed(0) + " " + "кілометри</td></tr>";
...
function print_extern_table(f1, f2, f3, data){ 
    ...
    if(Country=="PT" && isDef(data.distance_per_month)){
        ...
        //header
        varResult+="<tr><td><b>Custos externos</b><br>Percorre " +(1 * data.distance_per_month).toFixed(1)+" км/місяць</td>" +
                   "<td><b>Сумма на місяць</b></td></tr>";
        ...
        varResult+="<tr><td>" + ifr_estr_text + "</td>" + 
         ...
         //total
        varResult+="<tr><td style=\"padding:6px 10px 6px 0;\"><b>РАЗОМ</b></td>" +
                   "<td><b>₴&nbsp;"+data.external_costs.total_exter().toFixed(0)+"/місяць</b></td></tr>";
