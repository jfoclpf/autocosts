...
function Run2(callback){
    ...
    if(SOCIAL_SWITCH){
        $("#shareIcons").jsSocials({
            url: 'http://autocostos.info/PY',
            text: 'Esta calculadora te permitirá conocer el verdadero costo de ser propietario de un vehículo en Paraguay',
            showLabel: false,
            showCount: false,
...
function print_costs_table(f1, f2, f3, data) {
    ...
    {
        case "semestral":
            insurance_text = f1.insurance_value + " Guaraníes por semestre";
            break;
        case "anual":
            insurance_text = f1.insurance_value + " Guaraníes por año";
            break;
        case "mensal":
            insurance_text = data.monthly_costs.insurance + " Guaraníes por mes";
            break;
        case "trimestral":
            insurance_text = f1.insurance_value + " Guaraníes por trimestre";
            break;
    }
    ...
    switch(f2.type_calc_fuel){
        ...
        case "euros":
            ...
            {
                case "1":
                    fuel_text = f2.fuel_money + " Guaraníes por mes";
                    break;
                case "2":                   
                    fuel_text = f2.fuel_money + " kilómetros por bimestre";
                    break;
                case "3":                   
                    fuel_text = f2.fuel_money + " Guaraníes por trimestre";
                    break;
                case "4":                   
                    fuel_text = f2.fuel_money + " Guaraníes por semestre";
                    break;
                case "5":                   
                    fuel_text = f2.fuel_money + " Guaraníes por año";
                    break;
            }
            break;
    }
    ...
    var maintenance_text = "<b>1/2 Mantenimiento</b><br>" +
                           f2.maintenance + " Guaraníes por año";
    
    //Repairs
    var repairs_text = "<b>Reparaciones y mejoras<\/span></b><br>" +
                       f2.repairs + " Guaraníes por año";
    ...
    if(f2.type_calc_tolls == "false") {
        switch(data.tolls_period) {
            case "1":
                tolls_text += f2.tolls + " Guaraníes por mes";
                break;
            case "2":
                tolls_text += f2.tolls + " Guaraníes cada bimestre";
                break;
            case "3":
                tolls_text += f2.tolls + " Guaraníes por trimestre";
                break;
            case "4":
                tolls_text += f2.tolls + " Guaraníes por semestre";
                break;
            case "5":
                tolls_text += f2.tolls + " Guaraníes por año";
                break;
        }
    }
    else 
        tolls_text+=f2.price_tolls_p_day + " Guaraníes durante " + f2.tolls_days_p_month + " mes";
    tolls_text += "";
    ...
    switch(data.fines_period) {
        case "1":           
            fines_text += f2.fines + " Guaraníes por mes";
            break;
        case "2":           
            fines_text += f2.fines + " Guaraníes cada bimestre";
            break;
        case "3":           
            fines_text += f2.fines+" Guaraníes por trimestre";
            break;
        case "4":           
            fines_text += f2.fines + " Guaraníes por semestre";
            break;
        case "5":           
            fines_text += f2.fines + " Guaraníes por año";
            break;
        }
    fines_text+="";
    ...
    switch(data.washing_period) {
        case "1":
            washing_text += f2.washing + " Guaraníes por mes";
            break;
        case "2":
            washing_text += f2.washing + " Guaraníes cada bimestre";
            break;
        case "3":
            washing_text += f2.washing +" Guaraníes por trimestre";
            break;
        case "4":
            washing_text += f2.washing + " Guaraníes por semestre";
            break;
        case "5":
            washing_text += f2.washing + " Guaraníes por año";
            break;
        }
    washing_text+="";
